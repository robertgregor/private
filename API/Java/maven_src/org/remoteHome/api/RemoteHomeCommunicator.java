...
class RemoteHomeCommunicator extends Thread  { 
    ...
    public RemoteHomeCommunicator(String host, String port, RemoteHomeManager manager) throws RemoteHomeConnectionException {
        this.host = host;
        this.port = port;
    ...
    public void connect() throws RemoteHomeConnectionException {
            disconnect();
            try {
    ...
    public void connectComPort() throws RemoteHomeConnectionException {
            disconnect();
            try {
    ...
    public synchronized String sendCommandWithAnswer(int deviceId, String command) throws RemoteHomeConnectionException {
    ...
    public synchronized void addDevice(int deviceId) throws RemoteHomeConnectionException {
        cmdWithResponse = true;
        cmdWithResponseId = deviceId;
        try {
            dataReceived = "";
    ...
    public synchronized void sendCommand(int deviceId, String command) throws RemoteHomeConnectionException {
        try {
            dataReceived = "";
            String cmd = null;
            if (deviceId != -1) {
