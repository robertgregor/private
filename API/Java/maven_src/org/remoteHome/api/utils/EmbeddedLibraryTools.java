package org.remoteHome.api.utils;
...
public class EmbeddedLibraryTools {
    ...
    private static boolean loadEmbeddedLibrary() {
        ...
        for (String ext : allowedExtensions) {
            nativeLibraryUrl = EmbeddedLibraryTools.class.getResource(url.toString() + ext);
    ...
    public static void main(String[] args) {
        ...
        url.append("/libjzmq.");
        URL nativeLibraryUrl = EmbeddedLibraryTools.class.getResource(url.toString());
        // loop through extensions, stopping after finding first one
        /*
        for (String ext : allowedExtensions) {
            nativeLibraryUrl = EmbeddedLibraryTools.class.getResource(url.toString() + ext);
        ...
        */
        System.out.println(nativeLibraryUrl.toString());
