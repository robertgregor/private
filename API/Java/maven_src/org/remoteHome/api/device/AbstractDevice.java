...
public abstract class AbstractDevice implements Serializable, Comparable<AbstractDevice> {
     ...
     */
    public transient RemoteHomeManager m;
    ...
    public AbstractDevice (RemoteHomeManager m, int deviceId, String deviceName) {
        this.m = m;
  ...
  /**
    ...
    * @author Robert Gregor
    */
    public abstract void manageAsynchronousCommand(String[] items);
  ...
  /**
    ...
    */
    ...
    /**
     * @param switchNumber the subDeviceNumber to set
     */
    public void setSubDeviceNumber(String switchNumber) {
        this.subDeviceNumber = switchNumber;
    }
    
    public int parseDeviceIdForMultipleDevice(int deviceId) {
        if (deviceId < 256) {            
            return deviceId;
        } else {
