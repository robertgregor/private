...
public class LightAlarmDevice  extends SimpleSwitchDevice implements Serializable {
   ...
   /**
     ...
     */
    public LightAlarmDevice(RemoteHomeManager m, int deviceId, String deviceName) {
   ...
   /**
     ...
     */
    public void setOnWhenMovementDetected(boolean onWhenMovementDetected) {
     ...
     */
    public void setAlarmSensorCurrentState(boolean alarmSensorCurrentState) {
