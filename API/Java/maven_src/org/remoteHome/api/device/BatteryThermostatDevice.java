...
public class BatteryThermostatDevice extends AbstractDevice {
   ...
   /**
     * The constructor is public. The object should be constructed using
    ...
    public BatteryThermostatDevice(RemoteHomeManager m, int deviceId, String deviceName) {
     ...
     */
    public int getExpectedThreshold() {
     ...
     */
    public void setExpectedThreshold(int expectedThreshold) throws RemoteHomeManagerException {
     ...
     */
    public boolean isManageThresholdAuto() {
     ...
     */
    public void setManageThresholdAuto(boolean manageThresholdAuto) {
