...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00072	gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00075	Main_rx:

	LABEL?L	_Main_rx	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00076	gosub setup_rx 'setup Rx
	ICALL?L	L00001
	GOSUB?L	_setup_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00077	pause 2 'delay for Rx starting
	ICALL?L	L00001
	PAUSE?C	002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00078	Ce=1 'set nRF24L01 in Rx mode
	ICALL?L	L00001
	MOVE?CT	001h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00079	irqLoop:

	LABEL?L	_irqLoop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00081	if (temp_data[0] != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_temp_data, 000h, L00019

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00082	    if (configure == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_configure, 001h, L00021

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00083	        gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00084	        configure = 0
	ICALL?L	L00001
	MOVE?CB	000h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00085	    endif
	ICALL?L	L00001
	LABEL?L	L00021	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00086	    gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00087	    temp_data[0] = 0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00088	    GOTO main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00089	endif
	ICALL?L	L00001
	LABEL?L	L00019	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00090	If Irq !=0 then irqLoop 'wait until IRQ, active low
	ICALL?L	L00001
	CMPNE?TCL	_Irq, 000h, _irqLoop

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00091	Ce=0
	ICALL?L	L00001
	MOVE?CT	000h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00092	lop:

	LABEL?L	_lop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00093	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00094	gosub ackData
	GOSUB?L	_ackData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00096	temp_data[0] = 0
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00097	if (data_received[1] == device_id) then
	CMPNE?BBL	_data_received + 00001h, _device_id, L00023

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00098	    if (data_received[2] == "c") then    
	CMPNE?BCL	_data_received + 00002h, 063h, L00025

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00099	        if (data_received[3] == "=") then
	CMPNE?BCL	_data_received + 00003h, 03Dh, L00027

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00101	            for i = 0 to 10
	MOVE?CB	000h, _i
	LABEL?L	L00029	
	CMPGT?BCL	_i, 00Ah, L00030

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00102	                disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00103	                write i, data_received[i+4]
	ADD?BCW	_i, 004h, T1
	AOUT?BWB	_data_received, T1, T1
	WRITE?BB	_i, T1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00104	                enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00105	            next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00029
	LABEL?L	L00030	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00106	            read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00107	            pause 250
	ICALL?L	L00001
	PAUSE?C	0FAh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00108	            configure = 1
	ICALL?L	L00001
	MOVE?CB	001h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00109	            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00110	        endif
	ICALL?L	L00001
	LABEL?L	L00027	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00111	    ELSE
	ICALL?L	L00001
	GOTO?L	L00026
	LABEL?L	L00025	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00112	        if (data_received[2] == "s") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 073h, L00031

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00113	            temp_data[0] = "2"
	ICALL?L	L00001
	MOVE?CB	032h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00114	            temp_data[1] = "|"            
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00115	            temp_data[2] = 10    
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00116	        else
	ICALL?L	L00001
	GOTO?L	L00032
	LABEL?L	L00031	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00117	            if (data_received[2] == "p") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 070h, L00033

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00118	                if (data_received[3] == "n") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 06Eh, L00035

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00119	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00123	    endif
	ICALL?L	L00001
	LABEL?L	L00026	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00124	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00037

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00125	        temp_data[0] = "E"
	ICALL?L	L00001
	MOVE?CB	045h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00126	        temp_data[1] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00127	        temp_data[2] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00128	        temp_data[3] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00129	        temp_data[4] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00130	        temp_data[5] = 10
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00132	endif
	ICALL?L	L00001
	LABEL?L	L00023	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00133	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00134	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00135	end
	ICALL?L	L00001
	END?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00137	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00138	intManagement:

	LABEL?L	_intManagement	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00139	        if (INTCON.2 == 1) then
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00143	                        data_received[interi] = 0
	AIN?CBB	000h, _data_received, _interi

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00144	                    next interi
	NEXT?BCL	_interi, 001h, L00043
	LABEL?L	L00044	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00145	           endif
	LABEL?L	L00041	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00146	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00147	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00148	           seconds = seconds + 1
	ADD?BCB	_seconds, 001h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00149	           if seconds <= 58 then tiexit
	CMPLE?BCL	_seconds, 03Ah, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00150	           seconds = 0
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00151	           tiexit: 

	LABEL?L	_tiexit	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00152	           INTCON.2 = 0
	MOVE?CT	000h, _INTCON_2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00153	        endif
	LABEL?L	L00039	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00154	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON_7

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00155	resume
	RESUME?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00156	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00158	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00159	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00160	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00161	    temp_data[2] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00162	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00164	convertInputData:

	LABEL?L	_convertInputData	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00165	    conversionSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00166	    TEMP_BYTE="a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00167	    for ci=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _ci
	LABEL?L	L00045	
	CMPGT?BCL	_ci, 002h, L00046

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00168	        TEMP1_BYTE = "a"
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00171	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00172	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00049
	RETURN?	
	LABEL?L	L00049	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00173	        if (ci==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_ci, 000h, L00051

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00174	            TEMP_BYTE = TEMP1_BYTE
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00175	            conversionSuccess = 1 
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00176	        else 
	ICALL?L	L00001
	GOTO?L	L00052
	LABEL?L	L00051	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00177	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00179	        endif
	ICALL?L	L00001
	LABEL?L	L00052	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00180	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00181	    next ci
	ICALL?L	L00001
	NEXT?BCL	_ci, 001h, L00045
	LABEL?L	L00046	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00182	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00184	lookupChar:

	LABEL?L	_lookupChar	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00185	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00186	RETURN
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00188	convertNoToStr:

	LABEL?L	_convertNoToStr	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00189	        temp3_byte = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCB	T1, 030h, _temp3_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00190	        temp2_byte = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 001h, T1
	ADD?WCB	T1, 030h, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00191	        temp1_byte = (temp_byte DIG 0) + $30
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00194	setRxAddressPipe:

	LABEL?L	_setRxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00195	READ 6, data_out[1]
	ICALL?L	L00001
	READ?CB	006h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00196	READ 7, data_out[2]
	ICALL?L	L00001
	READ?CB	007h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00197	READ 8, data_out[3]
	ICALL?L	L00001
	READ?CB	008h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00198	READ 9, data_out[4]
	ICALL?L	L00001
	READ?CB	009h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00199	data_out[5] = device_id
	ICALL?L	L00001
	MOVE?BB	_device_id, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00200	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00202	setTxAddressPipe:

	LABEL?L	_setTxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00203	READ 1, data_out[1]
	ICALL?L	L00001
	READ?CB	001h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00204	READ 2, data_out[2]
	ICALL?L	L00001
	READ?CB	002h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00205	READ 3, data_out[3]
	ICALL?L	L00001
	READ?CB	003h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00206	READ 4, data_out[4]
	ICALL?L	L00001
	READ?CB	004h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00207	READ 5, data_out[5]
	ICALL?L	L00001
	READ?CB	005h, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00208	return
	ICALL?L	L00001
	RETURN?	
