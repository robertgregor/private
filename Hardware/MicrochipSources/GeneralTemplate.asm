...
#define		CODE_SIZE		 4
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00020	 DEFINE OSC 8
#define		OSC		 8
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00048	temp_word var word
_temp_word       		EQU	RAM_START + 082h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00041	ci var byte
_ci              		EQU	RAM_START + 084h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00042	configure var byte
_configure       		EQU	RAM_START + 085h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00054	conversionSuccess VAR BYTE
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00049	EEPROMBYTE      VAR BYTE
_EEPROMBYTE      		EQU	RAM_START + 088h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00050	EEPROMPOSITION  VAR BYTE
_EEPROMPOSITION  		EQU	RAM_START + 089h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00039	i VAR BYTE 'loop counter
_i               		EQU	RAM_START + 08Ah
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00040	j var byte
_j               		EQU	RAM_START + 08Bh
; C:\RH\PRIVATE\HARDWARE\MICROC~1\RFM73.PBP	00019	k VAR byte
_k               		EQU	RAM_START + 08Ch
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00053	l1counter var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00051	seconds  var     byte    ' Define second variable
_seconds         		EQU	RAM_START + 08Fh
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00045	temp1_byte var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00046	temp2_byte var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00047	temp3_byte var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00044	temp_byte var byte
_temp_byte       		EQU	RAM_START + 097h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00043	temp_byte_int var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00052	ticks   var     byte    ' Define pieces of seconds variable
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00018	INCLUDE "RFM73.pbp"
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00022	 OSCCON = %01110000 ' Internal 8MHz osc
	MOVE?CB	070h, OSCCON

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00023	 ANSEL = 0
	MOVE?CB	000h, ANSEL

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00024	 ANSELH = 0
	MOVE?CB	000h, ANSELH

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00025	 CM1CON0 = 0
	MOVE?CB	000h, CM1CON0

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00026	 CM2CON0 = 0
	MOVE?CB	000h, CM2CON0

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00029	    INTCON = %10100000  'T01 enabled PEIE disabled.
	MOVE?CB	0A0h, INTCON

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00030	    PIE1 = %00000000    'USART disabled
	MOVE?CB	000h, PIE1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00031	    OPTION_REG = %00000111
	MOVE?CB	007h, OPTION_REG

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00033	on interrupt goto intManagement
	ONINT?LL	_intManagement, L00001

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00034	ENABLE
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00036	TRISA = %00000000 'Set PORTA to all output
	ICALL?L	L00001
	MOVE?CB	000h, TRISA

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00037	TRISB = %00010000 'Set , SDI input
	ICALL?L	L00001
	MOVE?CB	010h, TRISB

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00038	TRISC = %00000100 'Set IRQ input
	ICALL?L	L00001
	MOVE?CB	004h, TRISC

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00056	clear
	ICALL?L	L00001
	CLEAR?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00057	read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00059	LOW PORTA.5
	ICALL?L	L00001
	LOW?T	_PORTA_5

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00060	LOW PORTA.4
	ICALL?L	L00001
	LOW?T	_PORTA_4

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00061	LOW PORTC.4
	ICALL?L	L00001
	LOW?T	_PORTC_4

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00062	LOW PORTC.3
	ICALL?L	L00001
	LOW?T	_PORTC_3

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00063	LOW PORTC.6
	ICALL?L	L00001
	LOW?T	_PORTC_6

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00064	LOW PORTC.5
	ICALL?L	L00001
	LOW?T	_PORTC_5

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00066	gosub initModule
	ICALL?L	L00001
	GOSUB?L	_initModule

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00068	commonSettings:

	LABEL?L	_commonSettings	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00069	gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00070	gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00073	Main_rx:

	LABEL?L	_Main_rx	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00074	gosub setup_rx 'setup Rx
	ICALL?L	L00001
	GOSUB?L	_setup_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00075	pause 2 'delay for Rx starting
	ICALL?L	L00001
	PAUSE?C	002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00076	Ce=1 'set nRF24L01 in Rx mode
	ICALL?L	L00001
	MOVE?CT	001h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00077	irqLoop:

	LABEL?L	_irqLoop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00079	if (temp_data[0] != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_temp_data, 000h, L00015

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00080	    if (configure == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_configure, 001h, L00017

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00081	        gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00082	        configure = 0
	ICALL?L	L00001
	MOVE?CB	000h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00083	    endif
	ICALL?L	L00001
	LABEL?L	L00017	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00084	    gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00085	    temp_data[0] = 0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00086	    GOTO main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00087	endif
	ICALL?L	L00001
	LABEL?L	L00015	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00088	If Irq !=0 then irqLoop 'wait until IRQ, active low
	ICALL?L	L00001
	CMPNE?TCL	_Irq, 000h, _irqLoop

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00089	Ce=0
	ICALL?L	L00001
	MOVE?CT	000h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00090	lop:

	LABEL?L	_lop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00091	data_out[0]=rd_rx_pload 'Read 5 bytes Rx pload
	ICALL?L	L00001
	MOVE?CB	_Rd_rx_pload, _data_out

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00092	num_byte=payloadLength
	ICALL?L	L00001
	MOVE?CB	_payloadLength, _num_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00093	gosub spi_read
	ICALL?L	L00001
	GOSUB?L	_spi_read

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00094	temp_data[0] = 0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00095	if (data_in[1] == device_id) then
	ICALL?L	L00001
	CMPNE?BBL	_data_in + 00001h, _device_id, L00019

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00096	    if (data_in[2] == "c") then    
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00002h, 063h, L00021

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00097	        if (data_in[3] == "=") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00003h, 03Dh, L00023

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00099	            for i = 0 to 10
	ICALL?L	L00001
	MOVE?CB	000h, _i
	LABEL?L	L00025	
	CMPGT?BCL	_i, 00Ah, L00026

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00100	                disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00101	                write i, data_in[i+4]
	ADD?BCW	_i, 004h, T1
	AOUT?BWB	_data_in, T1, T1
	WRITE?BB	_i, T1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00102	                enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00103	            next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00025
	LABEL?L	L00026	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00104	            read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00105	            pause 250
	ICALL?L	L00001
	PAUSE?C	0FAh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00106	            configure = 1
	ICALL?L	L00001
	MOVE?CB	001h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00107	            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00108	        endif
	ICALL?L	L00001
	LABEL?L	L00023	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00109	    ELSE
	ICALL?L	L00001
	GOTO?L	L00022
	LABEL?L	L00021	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00110	        if (data_in[2] == "s") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00002h, 073h, L00027

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00111	            temp_data[0] = "2"
	ICALL?L	L00001
	MOVE?CB	032h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00112	            temp_data[1] = "|"            
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00113	            temp_data[2] = 10    
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00114	        else
	ICALL?L	L00001
	GOTO?L	L00028
	LABEL?L	L00027	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00115	            if (data_in[2] == "p") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00002h, 070h, L00029

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00116	                if (data_in[3] == "n") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00003h, 06Eh, L00031

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00117	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00118	                endif
	ICALL?L	L00001
	LABEL?L	L00031	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00119	            endif
	ICALL?L	L00001
	LABEL?L	L00029	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00120	        endif
	ICALL?L	L00001
	LABEL?L	L00028	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00121	    endif
	ICALL?L	L00001
	LABEL?L	L00022	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00122	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00033

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00123	        temp_data[0] = "E"
	ICALL?L	L00001
	MOVE?CB	045h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00124	        temp_data[1] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00125	        temp_data[2] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00126	        temp_data[3] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00127	        temp_data[4] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00128	        temp_data[5] = 10
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00130	endif
	ICALL?L	L00001
	LABEL?L	L00019	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00132	data_out[0]=Fifo_status 'Read FIFO status
	ICALL?L	L00001
	MOVE?CB	_Fifo_status, _data_out

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00133	num_byte=1
	ICALL?L	L00001
	MOVE?CB	001h, _num_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00134	gosub spi_read
	ICALL?L	L00001
	GOSUB?L	_spi_read

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00135	val= data_in[1] 'FIFO status register
	ICALL?L	L00001
	MOVE?BB	_data_in + 00001h, _val

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00136	if val.0=0 then lop 'test RX_EMPTY=1, RX_FIFO empty
	ICALL?L	L00001
	CMPEQ?TCL	_val_0, 000h, _lop

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00137	data_out[0]=Write_reg+Stat_us 'reset RX_DR status bit
	ICALL?L	L00001
	MOVE?CB	027h, _data_out

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00138	data_out[1]=%01000000 'write 1 tp RX_DR to reset IRQ
	ICALL?L	L00001
	MOVE?CB	040h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00139	num_byte=1
	ICALL?L	L00001
	MOVE?CB	001h, _num_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00140	gosub spi_write
	ICALL?L	L00001
	GOSUB?L	_spi_write

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00141	pause 2 'wait 2ms Rx<->Tx
	ICALL?L	L00001
	PAUSE?C	002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00142	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00143	end
	ICALL?L	L00001
	END?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00145	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00146	intManagement:

	LABEL?L	_intManagement	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00147	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON_2, 001h, L00035

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00148	           ticks = ticks + 1      ' Count pieces of seconds
	ADD?BCB	_ticks, 001h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00149	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00150	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00151	           seconds = seconds + 1
	ADD?BCB	_seconds, 001h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00152	           if seconds <= 58 then tiexit
	CMPLE?BCL	_seconds, 03Ah, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00153	           seconds = 0
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00154	           tiexit: 

	LABEL?L	_tiexit	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00155	           INTCON.2 = 0
	MOVE?CT	000h, _INTCON_2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00156	        endif
	LABEL?L	L00035	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00157	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON_7

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00158	resume
	RESUME?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00159	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00161	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00162	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00163	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00164	    temp_data[2] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00165	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00167	convertInputData:

	LABEL?L	_convertInputData	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00168	    conversionSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00169	    TEMP_BYTE="a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00170	    for ci=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _ci
	LABEL?L	L00037	
	CMPGT?BCL	_ci, 002h, L00038

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00171	        TEMP1_BYTE = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00172	        TEMP2_BYTE = data_in[i]
	ICALL?L	L00001
	AOUT?BBB	_data_in, _i, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00173	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00039
	RETURN?	
	LABEL?L	L00039	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00174	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00175	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00041
	RETURN?	
	LABEL?L	L00041	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00176	        if (ci==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_ci, 000h, L00043

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00177	            TEMP_BYTE = TEMP1_BYTE
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00178	            conversionSuccess = 1 
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00179	        else 
	ICALL?L	L00001
	GOTO?L	L00044
	LABEL?L	L00043	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00180	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00182	        endif
	ICALL?L	L00001
	LABEL?L	L00044	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00183	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00184	    next ci
	ICALL?L	L00001
	NEXT?BCL	_ci, 001h, L00037
	LABEL?L	L00038	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00185	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00187	lookupChar:

	LABEL?L	_lookupChar	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00188	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00189	RETURN
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00191	convertNoToStr:

	LABEL?L	_convertNoToStr	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00192	        temp3_byte = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCB	T1, 030h, _temp3_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00193	        temp2_byte = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 001h, T1
	ADD?WCB	T1, 030h, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00194	        temp1_byte = (temp_byte DIG 0) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 000h, T1
	ADD?WCB	T1, 030h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00195	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00197	setRxAddressPipe:

	LABEL?L	_setRxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00198	READ 6, data_out[1]
	ICALL?L	L00001
	READ?CB	006h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00199	READ 7, data_out[2]
	ICALL?L	L00001
	READ?CB	007h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00200	READ 8, data_out[3]
	ICALL?L	L00001
	READ?CB	008h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00201	READ 9, data_out[4]
	ICALL?L	L00001
	READ?CB	009h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00202	data_out[5] = device_id
	ICALL?L	L00001
	MOVE?BB	_device_id, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00203	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00205	setTxAddressPipe:

	LABEL?L	_setTxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00206	READ 1, data_out[1]
	ICALL?L	L00001
	READ?CB	001h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00207	READ 2, data_out[2]
	ICALL?L	L00001
	READ?CB	002h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00208	READ 3, data_out[3]
	ICALL?L	L00001
	READ?CB	003h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00209	READ 4, data_out[4]
	ICALL?L	L00001
	READ?CB	004h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00210	READ 5, data_out[5]
	ICALL?L	L00001
	READ?CB	005h, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00211	return
	ICALL?L	L00001
	RETURN?	
