...
#define		OSC		 8
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00021	 DEFINE HSER_RCSTA 90h
#define		HSER_RCSTA		 90h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00022	 DEFINE HSER_TXSTA 24h
#define		HSER_TXSTA		 24h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00023	 DEFINE HSER_SPBRG 51
#define		HSER_SPBRG		 51
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00024	 DEFINE HSER_CLROERR 1
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00052	temp_word var word
_temp_word       		EQU	RAM_START + 04Eh
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00045	ci var byte
_ci              		EQU	RAM_START + 050h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00046	configure var byte
_configure       		EQU	RAM_START + 051h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00056	conversionSuccess VAR BYTE
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00053	EEPROMBYTE      VAR BYTE
_EEPROMBYTE      		EQU	RAM_START + 054h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00054	EEPROMPOSITION  VAR BYTE
_EEPROMPOSITION  		EQU	RAM_START + 055h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00043	i VAR BYTE 'loop counter
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00044	j var byte
_j               		EQU	RAM_START + 059h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\RFM73.PBP	00020	k VAR byte
_k               		EQU	RAM_START + 05Ah
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00055	l1counter var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00049	temp1_byte var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00050	temp2_byte var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00051	temp3_byte var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00048	temp_byte var byte
_temp_byte       		EQU	RAM_START + 0B4h
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00047	temp_byte_int var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00026	 OSCCON = %01110000 ' Internal 8MHz osc
	MOVE?CB	070h, OSCCON

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00027	 ANSEL = 0
	MOVE?CB	000h, ANSEL

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00028	 ANSELH = 0
	MOVE?CB	000h, ANSELH

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00029	 CM1CON0 = 0
	MOVE?CB	000h, CM1CON0

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00030	 CM2CON0 = 0
	MOVE?CB	000h, CM2CON0

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00033	    INTCON = %10100000  'T01 enabled PEIE disabled.
	MOVE?CB	0A0h, INTCON

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00034	    PIE1 = %00000000    'USART disabled
	MOVE?CB	000h, PIE1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00035	    OPTION_REG = %00000111
	MOVE?CB	007h, OPTION_REG

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00037	on interrupt goto intManagement
	ONINT?LL	_intManagement, L00001

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00038	ENABLE
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00040	TRISA = %00000000 'Set PORTA to all output
	ICALL?L	L00001
	MOVE?CB	000h, TRISA

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00041	TRISB = %00010000 'Set , SDI input
	ICALL?L	L00001
	MOVE?CB	010h, TRISB

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00042	TRISC = %00000100 'Set IRQ input
	ICALL?L	L00001
	MOVE?CB	004h, TRISC

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00058	clear
	ICALL?L	L00001
	CLEAR?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00059	read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00061	LOW PORTA.5
	ICALL?L	L00001
	LOW?T	_PORTA_5

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00062	LOW PORTA.4
	ICALL?L	L00001
	LOW?T	_PORTA_4

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00063	LOW PORTC.4
	ICALL?L	L00001
	LOW?T	_PORTC_4

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00064	LOW PORTC.3
	ICALL?L	L00001
	LOW?T	_PORTC_3

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00065	LOW PORTC.6
	ICALL?L	L00001
	LOW?T	_PORTC_6

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00066	LOW PORTC.5
	ICALL?L	L00001
	LOW?T	_PORTC_5

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00068	gosub initModule
	ICALL?L	L00001
	GOSUB?L	_initModule

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00070	commonSettings:

	LABEL?L	_commonSettings	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00071	gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00074	Main_rx:

	LABEL?L	_Main_rx	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00075	gosub setup_rx 'setup Rx
	ICALL?L	L00001
	GOSUB?L	_setup_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00076	pause 2 'delay for Rx starting
	ICALL?L	L00001
	PAUSE?C	002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00077	Ce=1 'set nRF24L01 in Rx mode
	ICALL?L	L00001
	MOVE?CT	001h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00078	irqLoop:

	LABEL?L	_irqLoop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00080	if (temp_data[0] != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_temp_data, 000h, L00019

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00081	    if (configure == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_configure, 001h, L00021

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00082	        gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00083	        configure = 0
	ICALL?L	L00001
	MOVE?CB	000h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00084	    endif
	ICALL?L	L00001
	LABEL?L	L00021	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00085	    gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00086	    temp_data[0] = 0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00087	    GOTO main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00089	If Irq !=0 then irqLoop 'wait until IRQ, active low
	ICALL?L	L00001
	CMPNE?TCL	_Irq, 000h, _irqLoop

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00090	Ce=0
	ICALL?L	L00001
	MOVE?CT	000h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00091	lop:

	LABEL?L	_lop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00092	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00093	gosub ackData
	GOSUB?L	_ackData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00095	temp_data[0] = 0
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00096	if (data_received[1] == device_id) then
	CMPNE?BBL	_data_received + 00001h, _device_id, L00023

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00097	    if (data_received[2] == "c") then    
	CMPNE?BCL	_data_received + 00002h, 063h, L00025

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00098	        if (data_received[3] == "=") then
	CMPNE?BCL	_data_received + 00003h, 03Dh, L00027

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00100	            for i = 0 to 10
	MOVE?CB	000h, _i
	LABEL?L	L00029	
	CMPGT?BCL	_i, 00Ah, L00030

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00101	                disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00102	                write i, data_received[i+4]
	ADD?BCW	_i, 004h, T1
	AOUT?BWB	_data_received, T1, T1
	WRITE?BB	_i, T1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00103	                enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00104	            next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00029
	LABEL?L	L00030	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00105	            read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00106	            pause 250
	ICALL?L	L00001
	PAUSE?C	0FAh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00107	            configure = 1
	ICALL?L	L00001
	MOVE?CB	001h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00108	            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00109	        endif
	ICALL?L	L00001
	LABEL?L	L00027	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00110	    ELSE
	ICALL?L	L00001
	GOTO?L	L00026
	LABEL?L	L00025	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00111	        if (data_received[2] == "s") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 073h, L00031

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00112	            temp_data[0] = "2"
	ICALL?L	L00001
	MOVE?CB	032h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00113	            temp_data[1] = "|"            
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00114	            temp_data[2] = 10    
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00115	        else
	ICALL?L	L00001
	GOTO?L	L00032
	LABEL?L	L00031	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00116	            if (data_received[2] == "p") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 070h, L00033

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00117	                if (data_received[3] == "n") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 06Eh, L00035

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00118	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00122	    endif
	ICALL?L	L00001
	LABEL?L	L00026	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00123	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00037

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00124	        temp_data[0] = "E"
	ICALL?L	L00001
	MOVE?CB	045h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00125	        temp_data[1] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00126	        temp_data[2] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00127	        temp_data[3] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00128	        temp_data[4] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00129	        temp_data[5] = 10
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00131	endif
	ICALL?L	L00001
	LABEL?L	L00023	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00132	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00133	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00134	end
	ICALL?L	L00001
	END?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00136	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00137	intManagement:

	LABEL?L	_intManagement	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00138	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON_2, 001h, L00039

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00139	           ticks = ticks + 1      ' Count pieces of seconds
	ADD?BCB	_ticks, 001h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00140	           if ticks = 10 then
	CMPNE?BCL	_ticks, 00Ah, L00041

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00141	                    for interi=0 to payloadLengthD - 1
	MOVE?CB	000h, _interi
	LABEL?L	L00043	
	CMPGT?BCL	_interi, 017h, L00044

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00142	                        data_received[interi] = 0
	AIN?CBB	000h, _data_received, _interi

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00143	                    next interi
	NEXT?BCL	_interi, 001h, L00043
	LABEL?L	L00044	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00144	           endif
	LABEL?L	L00041	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00145	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00146	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00147	           seconds = seconds + 1
	ADD?BCB	_seconds, 001h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00148	           if seconds <= 58 then tiexit
	CMPLE?BCL	_seconds, 03Ah, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00149	           seconds = 0
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00150	           tiexit: 

	LABEL?L	_tiexit	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00151	           INTCON.2 = 0
	MOVE?CT	000h, _INTCON_2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00152	        endif
	LABEL?L	L00039	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00153	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON_7

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00154	resume
	RESUME?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00155	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00157	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00158	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00159	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00160	    temp_data[2] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00161	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00163	convertInputData:

	LABEL?L	_convertInputData	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00164	    conversionSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00165	    TEMP_BYTE="a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00166	    for ci=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _ci
	LABEL?L	L00045	
	CMPGT?BCL	_ci, 002h, L00046

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00167	        TEMP1_BYTE = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00168	        TEMP2_BYTE = data_received[i]
	ICALL?L	L00001
	AOUT?BBB	_data_received, _i, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00169	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00047
	RETURN?	
	LABEL?L	L00047	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00170	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00171	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00049
	RETURN?	
	LABEL?L	L00049	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00172	        if (ci==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_ci, 000h, L00051

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00173	            TEMP_BYTE = TEMP1_BYTE
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00174	            conversionSuccess = 1 
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00175	        else 
	ICALL?L	L00001
	GOTO?L	L00052
	LABEL?L	L00051	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00176	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE
	ICALL?L	L00001
	MUL?BCW	_temp_byte, 00Ah, T1
	ADD?WBB	T1, _temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00177	            conversionSuccess = 1
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00178	        endif
	ICALL?L	L00001
	LABEL?L	L00052	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00179	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00180	    next ci
	ICALL?L	L00001
	NEXT?BCL	_ci, 001h, L00045
	LABEL?L	L00046	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00181	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00183	lookupChar:

	LABEL?L	_lookupChar	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00184	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00187	convertNoToStr:

	LABEL?L	_convertNoToStr	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00188	        temp3_byte = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCB	T1, 030h, _temp3_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00189	        temp2_byte = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 001h, T1
	ADD?WCB	T1, 030h, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00190	        temp1_byte = (temp_byte DIG 0) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 000h, T1
	ADD?WCB	T1, 030h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00191	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00193	setRxAddressPipe:

	LABEL?L	_setRxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00194	READ 6, data_out[1]
	ICALL?L	L00001
	READ?CB	006h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00195	READ 7, data_out[2]
	ICALL?L	L00001
	READ?CB	007h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00196	READ 8, data_out[3]
	ICALL?L	L00001
	READ?CB	008h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00197	READ 9, data_out[4]
	ICALL?L	L00001
	READ?CB	009h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00198	data_out[5] = device_id
	ICALL?L	L00001
	MOVE?BB	_device_id, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00199	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00201	setTxAddressPipe:

	LABEL?L	_setTxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00202	READ 1, data_out[1]
	ICALL?L	L00001
	READ?CB	001h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00203	READ 2, data_out[2]
	ICALL?L	L00001
	READ?CB	002h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00204	READ 3, data_out[3]
	ICALL?L	L00001
	READ?CB	003h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00205	READ 4, data_out[4]
	ICALL?L	L00001
	READ?CB	004h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00206	READ 5, data_out[5]
	ICALL?L	L00001
	READ?CB	005h, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\GENERA~1.PBP	00207	return
	ICALL?L	L00001
	RETURN?	
