...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00259	addNewDevice:
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00266	write 0, 40
	ICALL?L	L00001
	WRITEADDRESS?C	000h
	WRITE?C	028h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00267	write 1, "R"
	ICALL?L	L00001
	WRITEADDRESS?C	001h
	WRITE?C	052h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00268	write 2, "O"
	ICALL?L	L00001
	WRITEADDRESS?C	002h
	WRITE?C	04Fh

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00269	write 3, "B"
	ICALL?L	L00001
	WRITEADDRESS?C	003h
	WRITE?C	042h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00270	write 4, "I"
	ICALL?L	L00001
	WRITEADDRESS?C	004h
	WRITE?C	049h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00271	write 5, "K"
	ICALL?L	L00001
	WRITEADDRESS?C	005h
	WRITE?C	04Bh

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00273	device_id = 0
	ICALL?L	L00001
	MOVE?CB	000h, _device_id

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00274	temp_data[0] = "c"
	ICALL?L	L00001
	MOVE?CB	063h, _temp_data

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00275	temp_data[1] = "="
	ICALL?L	L00001
	MOVE?CB	03Dh, _temp_data + 00001h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00276	temp_data[2] = ser_data[0] 'password
	ICALL?L	L00001
	MOVE?BB	_ser_data, _temp_data + 00002h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00277	temp_data[3] = ser_data[1]
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00001h, _temp_data + 00003h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00278	temp_data[4] = ser_data[2]
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00002h, _temp_data + 00004h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00279	temp_data[5] = ser_data[3]
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00003h, _temp_data + 00005h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00280	temp_data[6] = ser_data[4]
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00004h, _temp_data + 00006h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00281	temp_data[7] = ser_data[5] 'channel
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00005h, _temp_data + 00007h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00282	temp_data[8] = temp_byte 'deviceId
	ICALL?L	L00001
	MOVE?BB	_temp_byte, _temp_data + 00008h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00283	temp_data[9] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00009h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00284	temp_data[10] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 0000Ah

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00285	GOSUB commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00286	gosub debounce
	ICALL?L	L00001
	GOSUB?L	_debounce

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00287	gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00288	gosub debounce
	ICALL?L	L00001
	GOSUB?L	_debounce

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00290	write 0, ser_data[5]
	ICALL?L	L00001
	WRITEADDRESS?C	000h
	WRITE?B	_ser_data + 00005h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00291	write 1, ser_data[0]
	ICALL?L	L00001
	WRITEADDRESS?C	001h
	WRITE?B	_ser_data

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00292	write 2, ser_data[1]
	ICALL?L	L00001
	WRITEADDRESS?C	002h
	WRITE?B	_ser_data + 00001h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00293	write 3, ser_data[2]
	ICALL?L	L00001
	WRITEADDRESS?C	003h
	WRITE?B	_ser_data + 00002h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00294	write 4, ser_data[3]
	ICALL?L	L00001
	WRITEADDRESS?C	004h
	WRITE?B	_ser_data + 00003h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00295	write 5, ser_data[4]
	ICALL?L	L00001
	WRITEADDRESS?C	005h
	WRITE?B	_ser_data + 00004h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00296	GOSUB commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00297	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00299	printConfig:

	LABEL?L	_printConfig	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00300	    read 0, temp_byte
	ICALL?L	L00001
	READADDRESS?C	000h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00301	    HSEROUT["+Channel:",DEC temp_byte,13,10]
	ICALL?L	L00001
	HSEROUT?C	02Bh
	HSEROUT?C	043h
	HSEROUT?C	068h
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00302	    HSEROUT["+Password:"]
	ICALL?L	L00001
	HSEROUT?C	02Bh
	HSEROUT?C	050h
	HSEROUT?C	061h
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00303	    read 1, temp_byte
	ICALL?L	L00001
	READADDRESS?C	001h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00304	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00305	    read 2, temp_byte
	ICALL?L	L00001
	READADDRESS?C	002h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00306	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00307	    read 3, temp_byte
	ICALL?L	L00001
	READADDRESS?C	003h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00308	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00309	    read 4, temp_byte
	ICALL?L	L00001
	READADDRESS?C	004h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00310	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00311	    read 5, temp_byte
	ICALL?L	L00001
	READADDRESS?C	005h
	READ?B	_temp_byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00313	    HSEROUT[13,10]
	ICALL?L	L00001
	HSEROUT?C	00Dh
	HSEROUT?C	00Ah

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00314	return
	ICALL?L	L00001
	RETURN?	
