...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00017	A000A0	temp_data var byte[payloadLength]
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00025	A000C2	device_id var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00019	A000C5	k VAR byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00012	A000C8	num_byte var byte 'temp value
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00021	A000CB	temp1_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00022	A000CD	temp2_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00023	A000CF	temp3_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00024	A000D1	temp4_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00020	A000D4	temp_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00013	A000D6	val var byte 'temp value
_val             		EQU	RAM_START + 0B6h
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00018	A000D7	w var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00014	INCLUDE "RFM70.pbp"
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00074	if (resetButton == 0) then
	ICALL?L	L00001
	CMPNE?TCL	_resetButton, 000h, L00017

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00075	    disable
	DISABLE?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00076	    write 0, 40
	WRITEADDRESS?C	000h
	WRITE?C	028h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00077	    write 1, "R"
	WRITEADDRESS?C	001h
	WRITE?C	052h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00078	    write 2, "O"
	WRITEADDRESS?C	002h
	WRITE?C	04Fh

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00079	    write 3, "B"
	WRITEADDRESS?C	003h
	WRITE?C	042h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00080	    write 4, "I"
	WRITEADDRESS?C	004h
	WRITE?C	049h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00081	    write 5, "K"
	WRITEADDRESS?C	005h
	WRITE?C	04Bh

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00082	    enable
	ENABLE?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00083	    gosub printConfig
	ICALL?L	L00001
	GOSUB?L	_printConfig

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00084	    pause 2000
	ICALL?L	L00001
	PAUSE?C	007D0h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00085	    goto resetLabel
	ICALL?L	L00001
	GOTO?L	_resetLabel

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00086	endif
	ICALL?L	L00001
	LABEL?L	L00017	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00087	if (manageSerial==1) then
	ICALL?L	L00001
	CMPNE?BCL	_manageSerial, 001h, L00019

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00088	    manageserial = 0
	ICALL?L	L00001
	MOVE?CB	000h, _manageSerial

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00089	    if ((ser_data[0] == "C" OR ser_data[0] == "c") AND ser_data[1] == "=") THEN 'channel
	ICALL?L	L00001
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00090	        i=2
	ICALL?L	L00001
	MOVE?CB	002h, _i

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00091	        GOSUB convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00092	        if (conversionSuccessfull == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccessfull, 001h, L00023

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00093	            if (temp_byte > 0) then                'not needed
	ICALL?L	L00001
	CMPLE?BCL	_temp_byte, 000h, L00025

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00094	                if (temp_byte < 255) then
	ICALL?L	L00001
	CMPGE?BCL	_temp_byte, 0FFh, L00027

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00095	                    write 0, temp_byte
	ICALL?L	L00001
	WRITEADDRESS?C	000h
	WRITE?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00096	                    gosub printOK
	ICALL?L	L00001
	GOSUB?L	_printOK

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00097	                    GOSUB commonSettings
	ICALL?L	L00001
	GOSUB?L	_commonSettings

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00098	                else
	ICALL?L	L00001
	GOTO?L	L00028
	LABEL?L	L00027	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00099	                    gosub printError
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00100	                endif
	ICALL?L	L00001
	LABEL?L	L00028	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00101	            else
	ICALL?L	L00001
	GOTO?L	L00026
	LABEL?L	L00025	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00102	                gosub printError
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00103	            endif
	ICALL?L	L00001
	LABEL?L	L00026	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00104	        else
	ICALL?L	L00001
	GOTO?L	L00024
	LABEL?L	L00023	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00105	            gosub printError
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00106	        endif
	ICALL?L	L00001
	LABEL?L	L00024	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00107	    elseif ((ser_data[0] == "P" OR ser_data[0] == "p") AND ser_data[1] == "=") THEN 'password
	ICALL?L	L00001
	GOTO?L	L00022
	LABEL?L	L00021	
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00108	        GOSUB savePwd
	ICALL?L	L00001
	GOSUB?L	_savePwd

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00109	        GOSUB commonSettings
	ICALL?L	L00001
	GOSUB?L	_commonSettings

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00110	    elseif ((ser_data[0] == "A" OR ser_data[0] == "a") AND ser_data[1] == "=") THEN 'add device
	ICALL?L	L00001
	GOTO?L	L00022
	LABEL?L	L00029	
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00111	        i=2
	ICALL?L	L00001
	MOVE?CB	002h, _i

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00112	        GOSUB convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00113	        if (conversionSuccessfull == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccessfull, 001h, L00033

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00114	            gosub addNewDevice
	ICALL?L	L00001
	GOSUB?L	_addNewDevice

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00115	            GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00116	        else
	ICALL?L	L00001
	GOTO?L	L00034
	LABEL?L	L00033	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00117	            gosub printError
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00118	        endif
	ICALL?L	L00001
	LABEL?L	L00034	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00119	    elseif ((ser_data[0] == "S" OR ser_data[0] == "s")) THEN 'print config
	ICALL?L	L00001
	GOTO?L	L00022
	LABEL?L	L00031	
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00120	        GOSUB printConfig
	ICALL?L	L00001
	GOSUB?L	_printConfig

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00121	    else
	ICALL?L	L00001
	GOTO?L	L00022
	LABEL?L	L00035	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00122	        i=0
	ICALL?L	L00001
	MOVE?CB	000h, _i

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00123	        gosub convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00124	        if (conversionSuccessfull != 1) then
	ICALL?L	L00001
	CMPEQ?BCL	_conversionSuccessfull, 001h, L00037

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00125	            gosub printError
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00126	        elseif (ser_data[i] != "=") then
	ICALL?L	L00001
	GOTO?L	L00038
	LABEL?L	L00037	
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00127	            gosub printError
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00128	        else
	ICALL?L	L00001
	GOTO?L	L00038
	LABEL?L	L00039	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00129	            device_id = temp_byte            
	ICALL?L	L00001
	MOVE?BB	_temp_byte, _device_id

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00130	            for j = 0 to payloadLength
	ICALL?L	L00001
	MOVE?CB	000h, _j
	LABEL?L	L00041	
	CMPGT?BCL	_j, _payloadLength, L00042

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00131	                temp_data[j]=ser_data[i + 1]
	ICALL?L	L00001
	ADD?BCW	_i, 001h, T1
	AOUT?BWB	_ser_data, T1, T1
	AIN?BBB	T1, _temp_data, _j

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00132	                if temp_data[j] == 0 then 
	ICALL?L	L00001
	AOUT?BBB	_temp_data, _j, T1
	CMPNE?BCL	T1, 000h, L00043

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00133	                    temp_data[j] = 10
	ICALL?L	L00001
	AIN?CBB	00Ah, _temp_data, _j

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00134	                    goto endCycleS
	ICALL?L	L00001
	GOTO?L	_endCycleS

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00135	                endif
	ICALL?L	L00001
	LABEL?L	L00043	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00136	                i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00137	                if (i==payloadLength) then
	ICALL?L	L00001
	CMPNE?BCL	_i, _payloadLength, L00045

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00138	                    gosub printError 
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00139	                    goto Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00140	                endif
	ICALL?L	L00001
	LABEL?L	L00045	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00141	            next j
	ICALL?L	L00001
	NEXT?BCL	_j, 001h, L00041
	LABEL?L	L00042	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00142	            :endCycleS

	LABEL?L	_endCycleS	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00143	        GOSUB commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00144	        gosub debounce
	ICALL?L	L00001
	GOSUB?L	_debounce

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00145	        GOSUB sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00146	        gosub debounce
	ICALL?L	L00001
	GOSUB?L	_debounce

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00147	        endif
	ICALL?L	L00001
	LABEL?L	L00038	
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00149	    GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00150	endif
	ICALL?L	L00001
	LABEL?L	L00019	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00151	If Irq !=0 then irqLoop 'wait until IRQ, active low
	ICALL?L	L00001
	CMPNE?TCL	_Irq, 000h, _irqLoop

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00153	Ce=0
	ICALL?L	L00001
	MOVE?CT	000h, _Ce

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00154	lop:

	LABEL?L	_lop	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00155	data_out[0]=rd_rx_pload 'Read 5 bytes Rx pload
	ICALL?L	L00001
	MOVE?CB	_Rd_rx_pload, _data_out

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00156	num_byte=payloadLength
	ICALL?L	L00001
	MOVE?CB	_payloadLength, _num_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00157	gosub spi_read
	ICALL?L	L00001
	GOSUB?L	_spi_read

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00158	HSEROUT["+", DEC data_in[1], " "]
	ICALL?L	L00001
	HSEROUT?C	02Bh
	HSEROUTCOUNT?C	000h
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00159	for w=2 to payloadLength
	ICALL?L	L00001
	MOVE?CB	002h, _w
	LABEL?L	L00047	
	CMPGT?BCL	_w, _payloadLength, L00048

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00160	    HSEROUT[data_in[w]]
	ICALL?L	L00001
	AOUT?BBB	_data_in, _w, T1
	HSEROUT?B	T1

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00161	    if (data_in[w]) == 10 then goto contInRcv
	ICALL?L	L00001
	AOUT?BBB	_data_in, _w, T1
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00162	next w
	ICALL?L	L00001
	NEXT?BCL	_w, 001h, L00047
	LABEL?L	L00048	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00163	contInRcv:

	LABEL?L	_contInRcv	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00164	data_out[0]=Fifo_status 'Read FIFO status
	ICALL?L	L00001
	MOVE?CB	_Fifo_status, _data_out

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00165	num_byte=1
	ICALL?L	L00001
	MOVE?CB	001h, _num_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00166	gosub spi_read
	ICALL?L	L00001
	GOSUB?L	_spi_read

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00167	val= data_in[1] 'FIFO status register
	ICALL?L	L00001
	MOVE?BB	_data_in + 00001h, _val

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00168	if val.0=0 then lop 'test RX_EMPTY=1, RX_FIFO empty
	ICALL?L	L00001
	CMPEQ?TCL	_val??0, 000h, _lop

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00169	endRx:

	LABEL?L	_endRx	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00170	data_out[0]=Write_reg+Stat_us 'reset RX_DR status bit
	ICALL?L	L00001
	MOVE?CB	027h, _data_out

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00171	data_out[1]=%01000000 'write 1 tp RX_DR to reset IRQ
	ICALL?L	L00001
	MOVE?CB	040h, _data_out + 00001h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00172	num_byte=1
	ICALL?L	L00001
	MOVE?CB	001h, _num_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00173	gosub spi_write
	ICALL?L	L00001
	GOSUB?L	_spi_write

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00174	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00175	end
	ICALL?L	L00001
	END?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00177	disable
	DISABLE?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00178	intManagement:

	LABEL?L	_intManagement	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00179	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON??2, 001h, L00051

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00180	           ticks = ticks + 1      ' Count pieces of seconds
	ADD?BCB	_ticks, 001h, _ticks

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00181	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00182	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00183	           seconds = seconds + 1
	ADD?BCB	_seconds, 001h, _seconds

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00184	           if seconds <= 58 then tiexit
	CMPLE?BCL	_seconds, 03Ah, _tiexit

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00185	           seconds = 0
	MOVE?CB	000h, _seconds

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00186	           minutes = minutes + 1
	ADD?BCB	_minutes, 001h, _minutes

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00187	           tiexit: 

	LABEL?L	_tiexit	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00188	           INTCON.2 = 0
	MOVE?CT	000h, _INTCON??2

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00189	        else 
	GOTO?L	L00052
	LABEL?L	L00051	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00190	            if (PIR1.5 == 1) then
	CMPNE?TCL	_PIR1??5, 001h, L00053

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00191	                 if (manageSerial == 1) then mainInt
	CMPEQ?BCL	_manageSerial, 001h, _mainInt

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00192	                 if (RCSTA.2 == 1) then
	CMPNE?TCL	_RCSTA??2, 001h, L00055

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00193	                    hserin[temp_byte_int]
	HSERIN?B	_temp_byte_int

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00194	                 endif
	LABEL?L	L00055	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00195	                 HSERIN 100, mainInt, [wait ("AT+"), STR ser_data\payloadLength\10]
	HSERINTIME?C	064h
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00196	                 manageSerial = 1
	MOVE?CB	001h, _manageSerial

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00197	                 :mainInt

	LABEL?L	_mainInt	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00198	            ENDIF
	LABEL?L	L00053	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00199	        endif
	LABEL?L	L00052	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00200	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON??7

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00201	resume
	RESUME?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00202	enable
	ENABLE?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00204	cleanSerialPort:

	LABEL?L	_cleanSerialPort	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00205	    while (PIR1.5==1) 
	ICALL?L	L00001
	LABEL?L	L00057	
	CMPNE?TCL	_PIR1??5, 001h, L00058

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00206	        hserin [temp_byte]
	ICALL?L	L00001
	HSERIN?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00207	    wend
	ICALL?L	L00001
	GOTO?L	L00057
	LABEL?L	L00058	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00208	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00211	printError:

	LABEL?L	_printError	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00212	    HSEROUT["ERROR",13,10]
	ICALL?L	L00001
	HSEROUT?C	045h
	HSEROUT?C	052h
	HSEROUT?C	052h
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00213	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00215	printOK:

	LABEL?L	_printOK	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00216	    HSEROUT["OK",13,10]
	ICALL?L	L00001
	HSEROUT?C	04Fh
	HSEROUT?C	04Bh
	HSEROUT?C	00Dh
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00217	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00219	convertInputData:

	LABEL?L	_convertInputData	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00220	    temp_word = 0
	ICALL?L	L00001
	MOVE?CW	000h, _temp_word

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00221	    conversionSuccessfull = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccessfull

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00222	    labelContReadDecimals:

	LABEL?L	_labelContReadDecimals	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00223	        if ser_data[i] > 47 then
	ICALL?L	L00001
	AOUT?BBB	_ser_data, _i, T1
	CMPLE?BCL	T1, 02Fh, L00059

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00224	            if ser_data[i] < 58 then
	ICALL?L	L00001
	AOUT?BBB	_ser_data, _i, T1
	CMPGE?BCL	T1, 03Ah, L00061

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00225	                conversionSuccessfull = 1
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccessfull

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00226	                TEMP_word = TEMP_word*10 + ((ser_data[i]+2)-50)
	ICALL?L	L00001
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00227	                i=i+1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00228	                if (TEMP_word < 256) then goto labelContReadDecimals
	ICALL?L	L00001
	CMPGE?WCL	_temp_word, 00100h, L00063
	GOTO?L	_labelContReadDecimals
	LABEL?L	L00063	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00229	            endif
	ICALL?L	L00001
	LABEL?L	L00061	
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00231	    if (TEMP_word > 255) then
	ICALL?L	L00001
	CMPLE?WCL	_temp_word, 0FFh, L00065

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00232	         conversionSuccessfull = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccessfull

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00233	    else
	ICALL?L	L00001
	GOTO?L	L00066
	LABEL?L	L00065	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00234	        temp_byte = TEMP_word
	ICALL?L	L00001
	MOVE?WB	_temp_word, _temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00235	    endif
	ICALL?L	L00001
	LABEL?L	L00066	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00236	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00242	savePwd:

	LABEL?L	_savePwd	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00243	    for i=2 to 6
	ICALL?L	L00001
	MOVE?CB	002h, _i
	LABEL?L	L00067	
	CMPGT?BCL	_i, 006h, L00068

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00244	        if (ser_data[i] == 0) or (ser_data[i] == 10) or (ser_data[i] == 13) or (ser_data[i] == " ") then 
	ICALL?L	L00001
	AOUT?BBB	_ser_data, _i, T1
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00245	            GOSUB printError
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00246	            return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00247	        endif
	ICALL?L	L00001
	LABEL?L	L00069	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00248	    next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00067
	LABEL?L	L00068	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00249	    if (ser_data[7] == 0) then    
	ICALL?L	L00001
	CMPNE?BCL	_ser_data + 00007h, 000h, L00071

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00250	        for i=2 to 6
	ICALL?L	L00001
	MOVE?CB	002h, _i
	LABEL?L	L00073	
	CMPGT?BCL	_i, 006h, L00074

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00251	            write i-1, ser_data[i]
	ICALL?L	L00001
	SUB?BCW	_i, 001h, T1
	WRITEADDRESS?W	T1
	AOUT?BBB	_ser_data, _i, T1
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00252	        next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00073
	LABEL?L	L00074	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00253	        gosub printOK
	ICALL?L	L00001
	GOSUB?L	_printOK

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00254	    else 
	ICALL?L	L00001
	GOTO?L	L00072
	LABEL?L	L00071	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00255	        gosub printError
	ICALL?L	L00001
	GOSUB?L	_printError

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00256	    endif
	ICALL?L	L00001
	LABEL?L	L00072	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00257	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00259	saveCurrentConfig:

	LABEL?L	_saveCurrentConfig	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00260	read 0, ser_data[5]
	ICALL?L	L00001
	READADDRESS?C	000h
	READ?B	_ser_data + 00005h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00261	READ 1, ser_data[0]
	ICALL?L	L00001
	READADDRESS?C	001h
	READ?B	_ser_data

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00262	READ 2, ser_data[1]
	ICALL?L	L00001
	READADDRESS?C	002h
	READ?B	_ser_data + 00001h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00263	READ 3, ser_data[2]
	ICALL?L	L00001
	READADDRESS?C	003h
	READ?B	_ser_data + 00002h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00264	READ 4, ser_data[3]
	ICALL?L	L00001
	READADDRESS?C	004h
	READ?B	_ser_data + 00003h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00265	READ 5, ser_data[4]
	ICALL?L	L00001
	READADDRESS?C	005h
	READ?B	_ser_data + 00004h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00266	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00268	restoreCurrentSettings:

	LABEL?L	_restoreCurrentSettings	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00269	write 0, ser_data[5]
	ICALL?L	L00001
	WRITEADDRESS?C	000h
	WRITE?B	_ser_data + 00005h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00270	write 1, ser_data[0]
	ICALL?L	L00001
	WRITEADDRESS?C	001h
	WRITE?B	_ser_data

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00271	write 2, ser_data[1]
	ICALL?L	L00001
	WRITEADDRESS?C	002h
	WRITE?B	_ser_data + 00001h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00272	write 3, ser_data[2]
	ICALL?L	L00001
	WRITEADDRESS?C	003h
	WRITE?B	_ser_data + 00002h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00273	write 4, ser_data[3]
	ICALL?L	L00001
	WRITEADDRESS?C	004h
	WRITE?B	_ser_data + 00003h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00274	write 5, ser_data[4]
	ICALL?L	L00001
	WRITEADDRESS?C	005h
	WRITE?B	_ser_data + 00004h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00275	GOSUB commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00276	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00278	putDefaultValues:

	LABEL?L	_putDefaultValues	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00279	write 0, 40
	ICALL?L	L00001
	WRITEADDRESS?C	000h
	WRITE?C	028h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00280	write 1, "R"
	ICALL?L	L00001
	WRITEADDRESS?C	001h
	WRITE?C	052h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00281	write 2, "O"
	ICALL?L	L00001
	WRITEADDRESS?C	002h
	WRITE?C	04Fh

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00282	write 3, "B"
	ICALL?L	L00001
	WRITEADDRESS?C	003h
	WRITE?C	042h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00283	write 4, "I"
	ICALL?L	L00001
	WRITEADDRESS?C	004h
	WRITE?C	049h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00284	write 5, "K"
	ICALL?L	L00001
	WRITEADDRESS?C	005h
	WRITE?C	04Bh

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00285	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00287	addNewDevice:

	LABEL?L	_addNewDevice	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00288	gosub saveCurrentConfig
	ICALL?L	L00001
	GOSUB?L	_saveCurrentConfig

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00289	GOSUB putDefaultValues:                                                                                                         
	ICALL?L	L00001
	GOSUB?L	_putDefaultValues

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00291	device_id = 0
	ICALL?L	L00001
	MOVE?CB	000h, _device_id

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00292	temp_data[0] = "c"
	ICALL?L	L00001
	MOVE?CB	063h, _temp_data

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00293	temp_data[1] = "="
	ICALL?L	L00001
	MOVE?CB	03Dh, _temp_data + 00001h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00294	temp_data[2] = ser_data[0] 'password
	ICALL?L	L00001
	MOVE?BB	_ser_data, _temp_data + 00002h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00295	temp_data[3] = ser_data[1]
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00001h, _temp_data + 00003h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00296	temp_data[4] = ser_data[2]
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00002h, _temp_data + 00004h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00297	temp_data[5] = ser_data[3]
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00003h, _temp_data + 00005h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00298	temp_data[6] = ser_data[4]
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00004h, _temp_data + 00006h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00299	temp_data[7] = ser_data[5] 'channel
	ICALL?L	L00001
	MOVE?BB	_ser_data + 00005h, _temp_data + 00007h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00300	temp_data[8] = temp_byte 'deviceId
	ICALL?L	L00001
	MOVE?BB	_temp_byte, _temp_data + 00008h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00301	temp_data[9] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00009h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00302	temp_data[10] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 0000Ah

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00303	GOSUB commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00304	gosub debounce
	ICALL?L	L00001
	GOSUB?L	_debounce

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00305	gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00306	gosub debounce
	ICALL?L	L00001
	GOSUB?L	_debounce

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00308	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00310	printConfig:

	LABEL?L	_printConfig	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00311	    read 0, temp_byte
	ICALL?L	L00001
	READADDRESS?C	000h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00312	    HSEROUT["+Channel:",DEC temp_byte,13,10]
	ICALL?L	L00001
	HSEROUT?C	02Bh
	HSEROUT?C	043h
	HSEROUT?C	068h
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00313	    HSEROUT["+Password:"]
	ICALL?L	L00001
	HSEROUT?C	02Bh
	HSEROUT?C	050h
	HSEROUT?C	061h
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00314	    read 1, temp_byte
	ICALL?L	L00001
	READADDRESS?C	001h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00315	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00316	    read 2, temp_byte
	ICALL?L	L00001
	READADDRESS?C	002h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00317	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00318	    read 3, temp_byte
	ICALL?L	L00001
	READADDRESS?C	003h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00319	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00320	    read 4, temp_byte
	ICALL?L	L00001
	READADDRESS?C	004h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00321	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00322	    read 5, temp_byte
	ICALL?L	L00001
	READADDRESS?C	005h
	READ?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00323	    HSEROUT[temp_byte]
	ICALL?L	L00001
	HSEROUT?B	_temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00324	    HSEROUT[13,10]
	ICALL?L	L00001
	HSEROUT?C	00Dh
	HSEROUT?C	00Ah

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\USBSTI~1.PBP	00325	return
	ICALL?L	L00001
	RETURN?	
