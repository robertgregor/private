...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00097	if (device_id != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_device_id, 000h, L00019

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00098	    gosub setModebasedonsleepperiod
	ICALL?L	L00001
	GOSUB?L	_setModebasedonsleepperiod

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00099	endif
	ICALL?L	L00001
	LABEL?L	L00019	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00100	Main_rx:

	LABEL?L	_Main_rx	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00101	gosub setup_rx 'setup Rx
	ICALL?L	L00001
	GOSUB?L	_setup_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00102	pause 2 'delay for Rx starting
	ICALL?L	L00001
	PAUSE?C	002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00103	Ce=1 'set nRF24L01 in Rx mode
	ICALL?L	L00001
	MOVE?CT	001h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00104	irqLoop:

	LABEL?L	_irqLoop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00106	if RES == 0 then
	ICALL?L	L00001
	CMPNE?TCL	_RES, 000h, L00021

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00107	    write 0, 40
	ICALL?L	L00001
	WRITE?CC	000h, 028h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00108	    write 1, "R"
	ICALL?L	L00001
	WRITE?CC	001h, 052h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00109	    write 2, "E"
	ICALL?L	L00001
	WRITE?CC	002h, 045h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00110	    write 3, "M"
	ICALL?L	L00001
	WRITE?CC	003h, 04Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00111	    write 4, "O"
	ICALL?L	L00001
	WRITE?CC	004h, 04Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00112	    write 5, "T"
	ICALL?L	L00001
	WRITE?CC	005h, 054h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00113	    write 6, "E"
	ICALL?L	L00001
	WRITE?CC	006h, 045h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00114	    write 7, "H"
	ICALL?L	L00001
	WRITE?CC	007h, 048h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00115	    write 8, "O"
	ICALL?L	L00001
	WRITE?CC	008h, 04Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00116	    write 9, "M"
	ICALL?L	L00001
	WRITE?CC	009h, 04Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00117	    write 10, 0
	ICALL?L	L00001
	WRITE?CC	00Ah, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00118	    write 11, 0
	ICALL?L	L00001
	WRITE?CC	00Bh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00119	    write 12, 12
	ICALL?L	L00001
	WRITE?CC	00Ch, 00Ch

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00120	    write 13, 44
	ICALL?L	L00001
	WRITE?CC	00Dh, 02Ch

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00121	    write 14, 0
	ICALL?L	L00001
	WRITE?CC	00Eh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00122	    pause 1000
	ICALL?L	L00001
	PAUSE?C	003E8h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00123	    goto startProg
	ICALL?L	L00001
	GOTO?L	_startProg

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00124	endif
	ICALL?L	L00001
	LABEL?L	L00021	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00125	if (normalMode == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_normalMode, 001h, L00023

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00126	    if (sleep_period != 0) then
	ICALL?L	L00001
	CMPEQ?WCL	_sleep_period, 000h, L00025

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00127	          normalMode = 2
	ICALL?L	L00001
	MOVE?CB	002h, _normalMode

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00128	           seconds = sleep_period
	ICALL?L	L00001
	MOVE?WB	_sleep_period, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00130	          gosub sendTemperature
	ICALL?L	L00001
	GOSUB?L	_sendTemperature

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00131	    endif
	ICALL?L	L00001
	LABEL?L	L00025	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00134	if (temp_data[0] != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_temp_data, 000h, L00027

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00135	    if (configure == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_configure, 001h, L00029

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00136	        gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00137	        configure = 0
	ICALL?L	L00001
	MOVE?CB	000h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00138	    endif
	ICALL?L	L00001
	LABEL?L	L00029	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00139	    gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00140	    TEMP_data[0] = 0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00141	    GOTO main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00142	endif
	ICALL?L	L00001
	LABEL?L	L00027	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00143	If Irq !=0 then irqLoop 'wait until IRQ, active low
	ICALL?L	L00001
	CMPNE?TCL	_Irq, 000h, _irqLoop

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00144	Ce=0
	ICALL?L	L00001
	MOVE?CT	000h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00145	lop:

	LABEL?L	_lop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00146	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00147	gosub ackData
	GOSUB?L	_ackData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00148	temp_data[0] = 0
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00149	if (data_received[1] == device_id) then
	CMPNE?BBL	_data_received + 00001h, _device_id, L00031

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00150	    if (data_received[3] == "=") then
	CMPNE?BCL	_data_received + 00003h, 03Dh, L00033

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00151	        i = 4
	MOVE?CB	004h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00152	        gosub convertInputData
	GOSUB?L	_convertInputData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00153	        if (data_received[2] == "c") then    
	CMPNE?BCL	_data_received + 00002h, 063h, L00035

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00155	            for i = 0 to 10
	MOVE?CB	000h, _i
	LABEL?L	L00037	
	CMPGT?BCL	_i, 00Ah, L00038

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00156	                disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00157	                write i, data_received[i+4]
	ADD?BCW	_i, 004h, T1
	AOUT?BWB	_data_received, T1, T1
	WRITE?BB	_i, T1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00158	                enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00159	            next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00037
	LABEL?L	L00038	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00160	            read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00161	            pause 250
	ICALL?L	L00001
	PAUSE?C	0FAh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00162	            configure = 1
	ICALL?L	L00001
	MOVE?CB	001h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00163	            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00164	        else
	ICALL?L	L00001
	GOTO?L	L00036
	LABEL?L	L00035	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00165	          if (confSuccess == 1) then                
	ICALL?L	L00001
	CMPNE?BCL	_confSuccess, 001h, L00039

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00166	            if (data_received[2] == "m") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 06Dh, L00041

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00167	                disable   
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00168	                write 12, temp_byte
	WRITE?CB	00Ch, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00169	                enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00170	                sleep_period = temp_byte * 10
	ICALL?L	L00001
	MUL?BCW	_temp_byte, 00Ah, _sleep_period

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00171	                seconds = sleep_period
	ICALL?L	L00001
	MOVE?WB	_sleep_period, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00172	                gosub setModeBasedOnSleepPeriod
	ICALL?L	L00001
	GOSUB?L	_setModebasedonsleepperiod

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00173	                gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00174	            else
	ICALL?L	L00001
	GOTO?L	L00042
	LABEL?L	L00041	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00175	                if (data_received[2] == "t") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 074h, L00043

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00176	                    disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00177	                    write 13, temp_byte
	WRITE?CB	00Dh, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00178	                    enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00179	                    temperatureExp = temp_byte
	ICALL?L	L00001
	MOVE?BB	_temp_byte, _temperatureExp

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00180	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00181	                else
	ICALL?L	L00001
	GOTO?L	L00044
	LABEL?L	L00043	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00182	                    if (data_received[2] == "r") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 072h, L00045

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00183	                        if (temp_byte < 10) then
	ICALL?L	L00001
	CMPGE?BCL	_temp_byte, 00Ah, L00047

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00184	                            disable 
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00185	                            write 11, temp_byte
	WRITE?CB	00Bh, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00186	                            enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00187	                            threshold = temp_byte
	ICALL?L	L00001
	MOVE?BB	_temp_byte, _threshold

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00188	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00189	                        endif
	ICALL?L	L00001
	LABEL?L	L00047	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00195	    ELSE
	ICALL?L	L00001
	GOTO?L	L00034
	LABEL?L	L00033	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00196	        if (data_received[2] == "s") then    
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 073h, L00049

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00197	            gosub sendTemperature
	ICALL?L	L00001
	GOSUB?L	_sendTemperature
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00199	            if (data_received[2] == "o") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 06Fh, L00051

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00200	                GOSUB relayOn
	ICALL?L	L00001
	GOSUB?L	_relayOn

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00201	                manualcontrol = 1
	ICALL?L	L00001
	MOVE?CB	001h, _manualcontrol

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00202	                GOSUB sendDataOK    
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00203	            ELSE
	ICALL?L	L00001
	GOTO?L	L00052
	LABEL?L	L00051	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00204	                if (data_received[2] == "f") then    
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 066h, L00053

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00205	                    GOSUB relayOff
	ICALL?L	L00001
	GOSUB?L	_relayOff

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00206	                    manualcontrol = 1
	ICALL?L	L00001
	MOVE?CB	001h, _manualcontrol

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00207	                    GOSUB sendDataOK    
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00208	                ELSE
	ICALL?L	L00001
	GOTO?L	L00054
	LABEL?L	L00053	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00209	                    if (data_received[2] == "x") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 078h, L00055

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00210	                        manualcontrol = 1
	ICALL?L	L00001
	MOVE?CB	001h, _manualcontrol

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00211	                        disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00212	                        write 14, 1
	WRITE?CC	00Eh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00213	                        enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00214	                        GOSUB sendDataOK    
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00215	                    ELSE
	ICALL?L	L00001
	GOTO?L	L00056
	LABEL?L	L00055	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00216	                        if (data_received[2] == "y") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 079h, L00057

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00217	                            manualcontrol = 0
	ICALL?L	L00001
	MOVE?CB	000h, _manualcontrol

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00218	                            disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00219	                            write 14, 0
	WRITE?CC	00Eh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00220	                            enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00221	                            GOSUB sendDataOK    
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00222	                        else
	ICALL?L	L00001
	GOTO?L	L00058
	LABEL?L	L00057	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00223	                            if (data_received[2] == "p") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 070h, L00059

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00224	                                if (data_received[3] == "n") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 06Eh, L00061

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00225	                                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00226	                                endif
	ICALL?L	L00001
	LABEL?L	L00061	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00234	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00063

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00235	        gosub sendError
	ICALL?L	L00001
	GOSUB?L	_sendError
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00238	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00239	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00240	end
	ICALL?L	L00001
	END?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00242	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00243	intManagement:

	LABEL?L	_intManagement	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00244	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON_2, 001h, L00065

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00245	           ticks = ticks + 1      ' Count pieces of seconds
	ADD?BCB	_ticks, 001h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00246	           if ticks = 5 then
	CMPNE?BCL	_ticks, 005h, L00067

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00247	                    for interi=0 to payloadLengthD - 1
	MOVE?CB	000h, _interi
	LABEL?L	L00069	
	CMPGT?BCL	_interi, 017h, L00070

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00248	                        data_received[interi] = 0
	AIN?CBB	000h, _data_received, _interi

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00249	                    next interi
	NEXT?BCL	_interi, 001h, L00069
	LABEL?L	L00070	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00250	           endif           
	LABEL?L	L00067	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00251	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00252	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00253	           realseconds = realseconds + 1
	ADD?BCB	_realseconds, 001h, _realseconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00254	           if (realseconds == 50) then
	CMPNE?BCL	_realseconds, 032h, L00071

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00255	                realseconds = 0
	MOVE?CB	000h, _realseconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00256	                if (differenceManaged == 0) then
	CMPNE?BCL	_differenceManaged, 000h, L00073

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00257	                    differenceManaged = 1
	MOVE?CB	001h, _differenceManaged

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00258	                    gosub readTempSensor
	GOSUB?L	_readTempSensor

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00259	                    difference = temperature - firstTemperature
	SUB?WWW	_temperature, _firstTemperature, _difference

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00260	                endif
	LABEL?L	L00073	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00261	           endif
	LABEL?L	L00071	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00262	           if (seconds > 0) then
	CMPLE?BCL	_seconds, 000h, L00075

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00263	                seconds = seconds - 1
	SUB?BCB	_seconds, 001h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00264	                if (seconds == 0) then
	CMPNE?BCL	_seconds, 000h, L00077

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00265	                    gosub setmodebasedonsleepperiod
	GOSUB?L	_setModebasedonsleepperiod

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00266	                endif
	LABEL?L	L00077	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00267	           endif
	LABEL?L	L00075	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00268	           tiexit: 

	LABEL?L	_tiexit	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00269	           INTCON.2 = 0
	MOVE?CT	000h, _INTCON_2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00270	        endif
	LABEL?L	L00065	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00271	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON_7

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00272	resume
	RESUME?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00273	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00275	sendError:

	LABEL?L	_sendError	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00276	        temp_data[0] = "E"
	ICALL?L	L00001
	MOVE?CB	045h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00277	        temp_data[1] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00278	        temp_data[2] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00279	        temp_data[3] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00280	        temp_data[4] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00281	        temp_data[5] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00282	        temp_data[6] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00283	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00285	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00286	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00287	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00288	    temp_data[2] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00289	    temp_data[3] = 10
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00292	convertInputData:

	LABEL?L	_convertInputData	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00293	    TEMP_BYTE=0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00294	    confSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _confSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00295	    for ic=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _ic
	LABEL?L	L00079	
	CMPGT?BCL	_ic, 002h, L00080

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00296	        TEMP1_BYTE = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00297	        TEMP2_BYTE = data_received[i]
	ICALL?L	L00001
	AOUT?BBB	_data_received, _i, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00298	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00081
	RETURN?	
	LABEL?L	L00081	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00299	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00300	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00083
	RETURN?	
	LABEL?L	L00083	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00301	        if (ic==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_ic, 000h, L00085

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00302	            TEMP_BYTE = TEMP1_BYTE
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00303	            confSuccess = 1 
	ICALL?L	L00001
	MOVE?CB	001h, _confSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00304	        else 
	ICALL?L	L00001
	GOTO?L	L00086
	LABEL?L	L00085	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00305	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE 
	ICALL?L	L00001
	MUL?BCW	_temp_byte, 00Ah, T1
	ADD?WBB	T1, _temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00306	            confSuccess = 1
	ICALL?L	L00001
	MOVE?CB	001h, _confSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00307	        endif
	ICALL?L	L00001
	LABEL?L	L00086	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00308	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00309	    next ic
	ICALL?L	L00001
	NEXT?BCL	_ic, 001h, L00079
	LABEL?L	L00080	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00310	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00312	lookupChar:

	LABEL?L	_lookupChar	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00313	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00314	RETURN
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00316	readTempSensor:

	LABEL?L	_readTempSensor	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00317	   OWOUT HEATING_SENSOR, 1, [$CC, $44] 'Skip ROM search & do temp conversion
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00318	  Wait_Up:

	LABEL?L	_Wait_Up	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00319	   OWIN HEATING_SENSOR, 4, [Busy]      'Read busy-bit
	ICALL?L	L00001
	OWPIN?T	_HEATING_SENSOR
	OWMODE?C	004h
	OWIN?T	_busy
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00320	   IF Busy = 0 THEN goto Wait_Up            'Still busy..?, Wait_Up..!
	ICALL?L	L00001
	CMPNE?TCL	_busy, 000h, L00087
	GOTO?L	_Wait_Up
	LABEL?L	L00087	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00321	   OWOUT HEATING_SENSOR, 1, [$CC, $BE] 'Skip ROM search & read scratchpad memory
	ICALL?L	L00001
	OWPIN?T	_HEATING_SENSOR
	OWMODE?C	001h
	OWOUT?C	0CCh
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00322	   OWIN HEATING_SENSOR, 2, [temperature.Lowbyte, temperature.Highbyte] 'Read two bytes / end comms
	ICALL?L	L00001
	OWPIN?T	_HEATING_SENSOR
	OWMODE?C	002h
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00323	   if (differenceManaged == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_differenceManaged, 001h, L00089

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00324	        temperature = temperature - difference
	ICALL?L	L00001
	SUB?WWW	_temperature, _difference, _temperature

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00325	   endif
	ICALL?L	L00001
	LABEL?L	L00089	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00326	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00328	sendTemperature:

	LABEL?L	_sendTemperature	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00330	   gosub readTempSensor
	ICALL?L	L00001
	GOSUB?L	_readTempSensor

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00331	   temp_data[0] = "6"
	ICALL?L	L00001
	MOVE?CB	036h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00332	   temp_data[1] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00333	   if (temperature.11 == 1) then
	ICALL?L	L00001
	CMPNE?TCL	_temperature_11, 001h, L00091

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00334	        temp_data[2] = "-"
	ICALL?L	L00001
	MOVE?CB	02Dh, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00335	        disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00336	        Dummy = 625 * (~temperature+1)
	NOT?WW	_temperature, T1
	ADD?WCW	T1, 001h, T1
	MUL?CWB	00271h, T1, _Dummy

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00337	        TempC = DIV32 10
	DIV32?CW	00Ah, _TempC

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00338	        enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00339	        temp_data[3] = (TempC DIG 4) + $30
	ICALL?L	L00001
	DIG?WCW	_TempC, 004h, T1
	ADD?WCB	T1, 030h, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00340	        temp_data[4] = (TempC DIG 3) + $30
	ICALL?L	L00001
	DIG?WCW	_TempC, 003h, T1
	ADD?WCB	T1, 030h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00341	        if (currentState != 1) then gosub relayOn
	ICALL?L	L00001
	CMPEQ?BCL	_currentState, 001h, L00093
	GOSUB?L	_relayOn
	LABEL?L	L00093	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00342	   else
	ICALL?L	L00001
	GOTO?L	L00092
	LABEL?L	L00091	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00343	        disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00344	        Dummy = 625 * temperature
	MUL?CWB	00271h, _temperature, _Dummy

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00345	        TempC = DIV32 10
	DIV32?CW	00Ah, _TempC

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00346	        enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00347	        TempC  = (temperature & $0FF0) >> 4 ' Mask middle 8-bits, shift into lower byte
	ICALL?L	L00001
	AND?WCW	_temperature, 00FF0h, T1
	SHIFTR?WCW	T1, 004h, _TempC

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00348	        Float = ((temperature.Lowbyte & $0F) * 625) ' Lower 4-bits of result * 625
	ICALL?L	L00001
	AND?BCW	_temperature_LOWBYTE, 00Fh, T1
	MUL?WCW	T1, 00271h, _Float

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00349	        temp_data[2] = (TempC DIG 1) + $30
	ICALL?L	L00001
	DIG?WCW	_TempC, 001h, T1
	ADD?WCB	T1, 030h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00350	        temp_data[3] = (TempC DIG 0) + $30
	ICALL?L	L00001
	DIG?WCW	_TempC, 000h, T1
	ADD?WCB	T1, 030h, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00351	        temp_data[4] = (Float DIG 3) + $30
	ICALL?L	L00001
	DIG?WCW	_Float, 003h, T1
	ADD?WCB	T1, 030h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00352	        temp3_word = (TempC.lowbyte * 10) + (temp_data[4] - $30)
	ICALL?L	L00001
	MUL?BCW	_TempC_LOWBYTE, 00Ah, T1
	SUB?BCW	_temp_data + 00004h, 030h, T2
	ADD?WWW	T1, T2, _temp3_word

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00354	        if (temp3_word < 30) then
	ICALL?L	L00001
	CMPGE?WCL	_temp3_word, 01Eh, L00095

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00355	            if (currentState != 1) then gosub relayOn
	ICALL?L	L00001
	CMPEQ?BCL	_currentState, 001h, L00097
	GOSUB?L	_relayOn
	LABEL?L	L00097	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00356	        else
	ICALL?L	L00001
	GOTO?L	L00096
	LABEL?L	L00095	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00357	            if (manualcontrol == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_manualcontrol, 000h, L00099

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00358	                if (temperatureExp != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_temperatureExp, 000h, L00101

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00359	                    temp_word = temp3_word + threshold
	ICALL?L	L00001
	ADD?WBW	_temp3_word, _threshold, _temp_word

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00360	                    temp2_word = ((temperatureExp / 2) * 10) + ((temperatureExp // 2) * 5)
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00361	                    if (temp_word > temp2_word) then
	ICALL?L	L00001
	CMPLE?WWL	_temp_word, _temp2_word, L00103

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00362	                        if (currentState != 0) then gosub relayOff
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00364	                        temp_word = temp3_word - threshold
	ICALL?L	L00001
	SUB?WBW	_temp3_word, _threshold, _temp_word

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00365	                        if (temp_word < temp2_word) then 
	ICALL?L	L00001
	CMPGE?WWL	_temp_word, _temp2_word, L00107

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00366	                            if (currentState != 1) then gosub relayOn
	ICALL?L	L00001
	CMPEQ?BCL	_currentState, 001h, L00109
	GOSUB?L	_relayOn
	LABEL?L	L00109	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00367	                        endif
	ICALL?L	L00001
	LABEL?L	L00107	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00373	        temp_data[5] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00374	        temp_byte = sleep_period / 10
	ICALL?L	L00001
	DIV?WCB	_sleep_period, 00Ah, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00375	        i=6
	ICALL?L	L00001
	MOVE?CB	006h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00376	        gosub printByteToTempByte
	ICALL?L	L00001
	GOSUB?L	_printByteToTempByte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00377	        temp_data[9] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00009h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00378	        i=9
	ICALL?L	L00001
	MOVE?CB	009h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00379	        temp_byte = temperatureExp
	ICALL?L	L00001
	MOVE?BB	_temperatureExp, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00380	        gosub print2LastBytesToTempByte
	ICALL?L	L00001
	GOSUB?L	_print2LastBytesToTempByte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00381	        temp_data[12] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 0000Ch

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00382	        temp_data[13] = currentState + $30
	ICALL?L	L00001
	ADD?BCB	_currentState, 030h, _temp_data + 0000Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00383	        temp_data[14] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 0000Eh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00384	        temp_data[15] = threshold + $30
	ICALL?L	L00001
	ADD?BCB	_threshold, 030h, _temp_data + 0000Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00385	        temp_data[16] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00010h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00386	        temp_data[17] = manualcontrol + $30
	ICALL?L	L00001
	ADD?BCB	_manualcontrol, 030h, _temp_data + 00011h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00387	        temp_data[18] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00012h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00388	        temp_data[19] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00013h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00389	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00391	printByteToTempByte:        

	LABEL?L	_printByteToTempByte	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00392	        temp_data[i] = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCW	T1, 030h, T1
	AIN?WBB	T1, _temp_data, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00393	print2LastBytesToTempByte:

	LABEL?L	_print2LastBytesToTempByte	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00394	        temp_data[i+1] = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	ADD?BCW	_i, 001h, T2
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00395	        temp_data[i+2] = (temp_byte DIG 0) + $30
	ICALL?L	L00001
	ADD?BCW	_i, 002h, T2
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00398	relayOff:

	LABEL?L	_relayOff	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00399	    LOW RELAY
	ICALL?L	L00001
	LOW?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00400	    currentState = 0
	ICALL?L	L00001
	MOVE?CB	000h, _currentState

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00401	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00403	relayOn:

	LABEL?L	_relayOn	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00404	    HIGH RELAY
	ICALL?L	L00001
	HIGH?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00405	    currentState = 1
	ICALL?L	L00001
	MOVE?CB	001h, _currentState

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00406	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00408	setModeBasedOnSleepPeriod:

	LABEL?L	_setModebasedonsleepperiod	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00409	    if (sleep_period == 0) then 
	ICALL?L	L00001
	CMPNE?WCL	_sleep_period, 000h, L00111

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00410	        normalMode = 0
	ICALL?L	L00001
	MOVE?CB	000h, _normalMode

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00411	    else     
	ICALL?L	L00001
	GOTO?L	L00112
	LABEL?L	L00111	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00412	        normalmode = 1
	ICALL?L	L00001
	MOVE?CB	001h, _normalMode

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00413	    endif
	ICALL?L	L00001
	LABEL?L	L00112	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00414	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00416	setRxAddressPipe:

	LABEL?L	_setRxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00417	READ 6, data_out[1]
	ICALL?L	L00001
	READ?CB	006h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00418	READ 7, data_out[2]
	ICALL?L	L00001
	READ?CB	007h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00419	READ 8, data_out[3]
	ICALL?L	L00001
	READ?CB	008h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00420	READ 9, data_out[4]
	ICALL?L	L00001
	READ?CB	009h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00421	data_out[5] = device_id
	ICALL?L	L00001
	MOVE?BB	_device_id, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00422	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00424	setTxAddressPipe:

	LABEL?L	_setTxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00425	READ 1, data_out[1]
	ICALL?L	L00001
	READ?CB	001h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00426	READ 2, data_out[2]
	ICALL?L	L00001
	READ?CB	002h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00427	READ 3, data_out[3]
	ICALL?L	L00001
	READ?CB	003h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00428	READ 4, data_out[4]
	ICALL?L	L00001
	READ?CB	004h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00429	READ 5, data_out[5]
	ICALL?L	L00001
	READ?CB	005h, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\THERMO~1.PBP	00430	return
	ICALL?L	L00001
	RETURN?	
