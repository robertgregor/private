...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00251	            temp_byte = currentCounter
	ICALL?L	L00001
	MOVE?BB	_currentCounter, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00252	            gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00253	            temp_data[10] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 0000Ah

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00254	            temp_data[11] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 0000Bh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00255	            temp_data[12] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 0000Ch

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00256	            temp_data[13] = 13    
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 0000Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00257	            temp_data[14] = 10    
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 0000Eh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00258	      else
	ICALL?L	L00001
	GOTO?L	L00072
	LABEL?L	L00071	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00259	       if (data_received[2] == "p") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 070h, L00073

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00260	            if (data_received[3] == "n") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 06Eh, L00075

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00261	                gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00262	            endif
	ICALL?L	L00001
	LABEL?L	L00075	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00263	       else
	ICALL?L	L00001
	GOTO?L	L00074
	LABEL?L	L00073	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00264	        if (data_received[2] == "u") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 075h, L00077

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00265	         gosub blindsUp
	ICALL?L	L00001
	GOSUB?L	_blindsup

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00266	         gosub sendDataOK        
	ICALL?L	L00001
	GOSUB?L	_sendDataOK
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00268	         if (data_received[2] == "d") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 064h, L00079

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00269	          gosub blindsDown
	ICALL?L	L00001
	GOSUB?L	_blindsDown
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00272	          if (data_received[2] == "e") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 065h, L00081

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00273	           gosub stopBlindsSilent
	ICALL?L	L00001
	GOSUB?L	_stopBlindsSilent
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00275	          endif
	ICALL?L	L00001
	LABEL?L	L00081	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00282	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00083

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00283	        temp_data[0] = "E"
	ICALL?L	L00001
	MOVE?CB	045h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00284	        temp_data[1] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00285	        temp_data[2] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00286	        temp_data[3] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00287	        temp_data[4] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00288	        temp_data[5] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00289	        temp_data[6] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00290	    endif
	ICALL?L	L00001
	LABEL?L	L00083	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00292	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00293	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00294	end
	ICALL?L	L00001
	END?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00296	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00297	intManagement:

	LABEL?L	_intManagement	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00298	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON_2, 001h, L00085

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00299	           ticks = ticks + 1      ' Count pieces of seconds
	ADD?BCB	_ticks, 001h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00300	           if ticks = 10 then
	CMPNE?BCL	_ticks, 00Ah, L00087

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00301	                    for interi=0 to payloadLengthD - 1
	MOVE?CB	000h, _interi
	LABEL?L	L00089	
	CMPGT?BCL	_interi, 017h, L00090

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00302	                        data_received[interi] = 0
	AIN?CBB	000h, _data_received, _interi

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00303	                    next interi
	NEXT?BCL	_interi, 001h, L00089
	LABEL?L	L00090	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00304	           endif                      
	LABEL?L	L00087	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00305	           if (counter > 0) then
	CMPLE?WCL	_counter, 000h, L00091

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00306	               counter = counter - 1
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00308	                    GOSUB stopBlinds
	GOSUB?L	_stopBlinds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00309	               endif
	LABEL?L	L00093	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00310	           endif
	LABEL?L	L00091	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00311	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00312	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00313	           seconds = seconds + 1
	ADD?BCB	_seconds, 001h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00314	           if seconds <= 59 then tiexit
	CMPLE?BCL	_seconds, 03Bh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00315	           seconds = 0
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00316	           tiexit: 

	LABEL?L	_tiexit	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00317	           INTCON.2 = 0
	MOVE?CT	000h, _INTCON_2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00318	        endif
	LABEL?L	L00085	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00319	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON_7

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00320	resume
	RESUME?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00321	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00323	stopBlinds:

	LABEL?L	_stopBlinds	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00324	    low RELAY_DOWN
	ICALL?L	L00001
	LOW?T	_RELAY_DOWN

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00325	    low RELAY_UP
	ICALL?L	L00001
	LOW?T	_RELAY_UP

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00326	    gosub sendCurrentPosition
	ICALL?L	L00001
	GOSUB?L	_sendCurrentPosition

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00327	    currentDirection = 0
	ICALL?L	L00001
	MOVE?CB	000h, _currentDirection

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00328	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00330	stopBlindsSilent:

	LABEL?L	_stopBlindsSilent	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00331	    low RELAY_DOWN
	ICALL?L	L00001
	LOW?T	_RELAY_DOWN

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00332	    low RELAY_UP
	ICALL?L	L00001
	LOW?T	_RELAY_UP

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00333	    currentDirection = 0
	ICALL?L	L00001
	MOVE?CB	000h, _currentDirection

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00334	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00336	blindsUp:

	LABEL?L	_blindsup	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00337	    gosub stopBlindsSilent
	ICALL?L	L00001
	GOSUB?L	_stopBlindsSilent

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00338	    pause 100
	ICALL?L	L00001
	PAUSE?C	064h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00339	    high RELAY_DOWN
	ICALL?L	L00001
	HIGH?T	_RELAY_DOWN

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00340	    low RELAY_UP
	ICALL?L	L00001
	LOW?T	_RELAY_UP

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00341	    currentDirection = 2
	ICALL?L	L00001
	MOVE?CB	002h, _currentDirection

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00342	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00344	blindsDown:

	LABEL?L	_blindsDown	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00345	    gosub stopBlindsSilent
	ICALL?L	L00001
	GOSUB?L	_stopBlindsSilent

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00346	    pause 100
	ICALL?L	L00001
	PAUSE?C	064h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00347	    LOW RELAY_DOWN
	ICALL?L	L00001
	LOW?T	_RELAY_DOWN

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00348	    HIGH RELAY_UP
	ICALL?L	L00001
	HIGH?T	_RELAY_UP

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00349	    currentDirection = 1
	ICALL?L	L00001
	MOVE?CB	001h, _currentDirection

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00350	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00352	sendCurrentPosition:

	LABEL?L	_sendCurrentPosition	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00353	    temp_data[0] = "l"
	ICALL?L	L00001
	MOVE?CB	06Ch, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00354	    temp_data[1] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00355	    temp_byte = currentCounter
	ICALL?L	L00001
	MOVE?BB	_currentCounter, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00356	    gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00357	    temp_data[2] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00358	    temp_data[3] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00359	    temp_data[4] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00360	    temp_data[5] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00361	    temp_data[6] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00362	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00364	computeCounter:

	LABEL?L	_computeCounter	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00365	    disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00366	    temp_word = timeout_value * temp2_byte
	MUL?WBW	_timeout_value, _temp2_byte, _temp_word

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00367	    counter = div32 100
	DIV32?CW	064h, _counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00368	    enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00369	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00371	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00372	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00373	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00374	    temp_data[2] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00375	    temp_data[3] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00376	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00378	convertInputData:

	LABEL?L	_convertInputData	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00379	    conversionSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00380	    TEMP_BYTE="a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00381	    for ci=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _ci
	LABEL?L	L00095	
	CMPGT?BCL	_ci, 002h, L00096

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00382	        TEMP1_BYTE = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00383	        TEMP2_BYTE = data_received[i]
	ICALL?L	L00001
	AOUT?BBB	_data_received, _i, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00384	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00097
	RETURN?	
	LABEL?L	L00097	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00385	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00386	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00099
	RETURN?	
	LABEL?L	L00099	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00387	        if (ci==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_ci, 000h, L00101

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00388	            TEMP_BYTE = TEMP1_BYTE
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00389	            conversionSuccess = 1 
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00390	        else 
	ICALL?L	L00001
	GOTO?L	L00102
	LABEL?L	L00101	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00391	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE
	ICALL?L	L00001
	MUL?BCW	_temp_byte, 00Ah, T1
	ADD?WBB	T1, _temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00392	            conversionSuccess = 1
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00393	        endif
	ICALL?L	L00001
	LABEL?L	L00102	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00394	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00395	    next ci
	ICALL?L	L00001
	NEXT?BCL	_ci, 001h, L00095
	LABEL?L	L00096	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00396	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00398	lookupChar:

	LABEL?L	_lookupChar	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00399	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00400	RETURN
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00402	convertNoToStr:

	LABEL?L	_convertNoToStr	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00403	        temp3_byte = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCB	T1, 030h, _temp3_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00404	        temp2_byte = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 001h, T1
	ADD?WCB	T1, 030h, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00405	        temp1_byte = (temp_byte DIG 0) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 000h, T1
	ADD?WCB	T1, 030h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00406	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00408	setRxAddressPipe:

	LABEL?L	_setRxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00409	READ 6, data_out[1]
	ICALL?L	L00001
	READ?CB	006h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00410	READ 7, data_out[2]
	ICALL?L	L00001
	READ?CB	007h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00411	READ 8, data_out[3]
	ICALL?L	L00001
	READ?CB	008h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00412	READ 9, data_out[4]
	ICALL?L	L00001
	READ?CB	009h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00413	data_out[5] = device_id
	ICALL?L	L00001
	MOVE?BB	_device_id, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00414	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00416	setTxAddressPipe:

	LABEL?L	_setTxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00417	READ 1, data_out[1]
	ICALL?L	L00001
	READ?CB	001h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00418	READ 2, data_out[2]
	ICALL?L	L00001
	READ?CB	002h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00419	READ 3, data_out[3]
	ICALL?L	L00001
	READ?CB	003h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00420	READ 4, data_out[4]
	ICALL?L	L00001
	READ?CB	004h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00421	READ 5, data_out[5]
	ICALL?L	L00001
	READ?CB	005h, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SWITCH~1.PBP	00422	return
	ICALL?L	L00001
	RETURN?	
