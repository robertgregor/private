...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00089	Main_rx:

	LABEL?L	_Main_rx	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00090	gosub setup_rx 'setup Rx
	ICALL?L	L00001
	GOSUB?L	_setup_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00091	pause 2 'delay for Rx starting
	ICALL?L	L00001
	PAUSE?C	002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00092	Ce=1 'set nRF24L01 in Rx mode
	ICALL?L	L00001
	MOVE?CT	001h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00093	irqLoop:

	LABEL?L	_irqLoop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00095	if RES == 0 then
	ICALL?L	L00001
	CMPNE?TCL	_RES, 000h, L00021

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00096	    disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00097	    write 0, 40
	WRITE?CC	000h, 028h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00098	    write 1, "R"
	WRITE?CC	001h, 052h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00099	    write 2, "E"
	WRITE?CC	002h, 045h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00100	    write 3, "M"
	WRITE?CC	003h, 04Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00101	    write 4, "O"
	WRITE?CC	004h, 04Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00102	    write 5, "T"
	WRITE?CC	005h, 054h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00103	    write 6, "E"
	WRITE?CC	006h, 045h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00104	    write 7, "H"
	WRITE?CC	007h, 048h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00105	    write 8, "O"
	WRITE?CC	008h, 04Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00106	    write 9, "M"
	WRITE?CC	009h, 04Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00107	    write 10, 0
	WRITE?CC	00Ah, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00108	    write 11, 1
	WRITE?CC	00Bh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00109	    write 12, 0
	WRITE?CC	00Ch, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00110	    write 13, 0
	WRITE?CC	00Dh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00111	    write 14, 0
	WRITE?CC	00Eh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00112	    write 15, 0
	WRITE?CC	00Fh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00113	    enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00114	    pause 1000
	ICALL?L	L00001
	PAUSE?C	003E8h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00115	    goto startLabel
	ICALL?L	L00001
	GOTO?L	_startLabel

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00116	endif
	ICALL?L	L00001
	LABEL?L	L00021	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00117	if (temp_data[0] != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_temp_data, 000h, L00023

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00118	    if (configure == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_configure, 001h, L00025

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00119	        gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00120	        configure = 0
	ICALL?L	L00001
	MOVE?CB	000h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00121	    endif
	ICALL?L	L00001
	LABEL?L	L00025	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00122	    gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00123	    temp_data[0] = 0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00124	    GOTO main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00125	endif
	ICALL?L	L00001
	LABEL?L	L00023	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00127	if (ALSTATUS == 5) then
	ICALL?L	L00001
	CMPNE?BCL	_ALSTATUS, 005h, L00027

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00128	    ALSTATUS = 2
	ICALL?L	L00001
	MOVE?CB	002h, _ALSTATUS

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00129	    temp_data[0] = "A"
	ICALL?L	L00001
	MOVE?CB	041h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00130	    temp_data[1] = "L"
	ICALL?L	L00001
	MOVE?CB	04Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00131	    temp_data[2] = "A"
	ICALL?L	L00001
	MOVE?CB	041h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00132	    temp_data[3] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00133	    temp_data[4] = "M"
	ICALL?L	L00001
	MOVE?CB	04Dh, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00134	    temp_data[5] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00135	    temp_data[6] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00136	endif
	ICALL?L	L00001
	LABEL?L	L00027	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00137	If Irq !=0 then irqLoop 'wait until IRQ, active low
	ICALL?L	L00001
	CMPNE?TCL	_Irq, 000h, _irqLoop

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00138	Ce=0
	ICALL?L	L00001
	MOVE?CT	000h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00139	lop:

	LABEL?L	_lop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00140	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00141	gosub ackData
	GOSUB?L	_ackData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00142	temp_data[0] = 0
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00143	if (data_received[1] == device_id) then
	CMPNE?BBL	_data_received + 00001h, _device_id, L00029

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00144	    if (data_received[2] == "c") then    
	CMPNE?BCL	_data_received + 00002h, 063h, L00031

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00145	        if (data_received[3] == "=") then
	CMPNE?BCL	_data_received + 00003h, 03Dh, L00033

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00147	            for i = 0 to 10
	MOVE?CB	000h, _i
	LABEL?L	L00035	
	CMPGT?BCL	_i, 00Ah, L00036

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00148	                disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00149	                write i, data_received[i+4]
	ADD?BCW	_i, 004h, T1
	AOUT?BWB	_data_received, T1, T1
	WRITE?BB	_i, T1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00150	                enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00151	            next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00035
	LABEL?L	L00036	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00152	            read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00153	            pause 250
	ICALL?L	L00001
	PAUSE?C	0FAh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00154	            configure = 1
	ICALL?L	L00001
	MOVE?CB	001h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00155	            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00156	        endif
	ICALL?L	L00001
	LABEL?L	L00033	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00158	    if (data_received[2] == "l") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 06Ch, L00037

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00159	        if (data_received[3] == "1") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 031h, L00039

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00160	            if (data_received[4] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 063h, L00041

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00161	                if (data_received[5] == "o") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 06Fh, L00043

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00162	                    disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00163	                    write 11, 0
	WRITE?CC	00Bh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00164	                    enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00165	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00166	                endif
	ICALL?L	L00001
	LABEL?L	L00043	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00167	                if (data_received[5] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 066h, L00045

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00168	                    disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00169	                    write 11, 1
	WRITE?CC	00Bh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00170	                    enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00171	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00172	                endif
	ICALL?L	L00001
	LABEL?L	L00045	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00173	                if (data_received[5] == "d") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 064h, L00047

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00174	                    disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00175	                    write 13, 1
	WRITE?CC	00Dh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00176	                    enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00177	                    l1onAlarm = 1
	ICALL?L	L00001
	MOVE?CB	001h, _l1onAlarm

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00178	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00179	                endif
	ICALL?L	L00001
	LABEL?L	L00047	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00180	                if (data_received[5] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 063h, L00049

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00181	                    disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00182	                    write 13, 0
	WRITE?CC	00Dh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00183	                    enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00184	                    l1onAlarm = 0
	ICALL?L	L00001
	MOVE?CB	000h, _l1onAlarm

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00185	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00186	                endif                
	ICALL?L	L00001
	LABEL?L	L00049	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00187	                if (data_received[5] == "t") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 074h, L00051

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00188	                    if (data_received[6] == "=") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00006h, 03Dh, L00053

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00189	                        i = 7
	ICALL?L	L00001
	MOVE?CB	007h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00190	                        gosub convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00191	                        if (conversionSuccess == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccess, 001h, L00055

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00192	                            disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00193	                            write 12, temp_byte
	WRITE?CB	00Ch, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00194	                            enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00195	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00196	                        else
	ICALL?L	L00001
	GOTO?L	L00056
	LABEL?L	L00055	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00197	                            gosub sendDataError
	ICALL?L	L00001
	GOSUB?L	_sendDataError

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00198	                        endif
	ICALL?L	L00001
	LABEL?L	L00056	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00202	            if (data_received[4] == "o") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 06Fh, L00057

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00203	                if (data_received[5] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 066h, L00059

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00204	                    seconds = 0
	ICALL?L	L00001
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00205	                    read 12, l1counter
	ICALL?L	L00001
	READ?CB	00Ch, _l1counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00206	                    gosub highRelay
	ICALL?L	L00001
	GOSUB?L	_highRelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00207	                else
	ICALL?L	L00001
	GOTO?L	L00060
	LABEL?L	L00059	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00208	                    gosub highRelay
	ICALL?L	L00001
	GOSUB?L	_highRelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00209	                    l1counter = 0
	ICALL?L	L00001
	MOVE?CB	000h, _l1counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00210	                endif
	ICALL?L	L00001
	LABEL?L	L00060	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00211	                gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00212	            endif
	ICALL?L	L00001
	LABEL?L	L00057	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00213	            if (data_received[4] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 066h, L00061

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00214	                gosub LOWrelay
	ICALL?L	L00001
	GOSUB?L	_lowrelay
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00219	    if (data_received[2] == "a") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 061h, L00063

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00220	        if (data_received[3] == "l") then 
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 06Ch, L00065

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00221	            if (data_received[4] == "a") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 061h, L00067

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00222	                read 15, ALLeaveCounter
	ICALL?L	L00001
	READ?CB	00Fh, _ALLeaveCounter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00223	                ALEnterCounter = 0
	ICALL?L	L00001
	MOVE?CB	000h, _ALEnterCounter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00224	                if (ALLeaveCounter == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_ALLeaveCounter, 000h, L00069

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00225	                    alstatus = 1
	ICALL?L	L00001
	MOVE?CB	001h, _ALSTATUS

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00226	                else
	ICALL?L	L00001
	GOTO?L	L00070
	LABEL?L	L00069	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00227	                    alstatus = 3
	ICALL?L	L00001
	MOVE?CB	003h, _ALSTATUS

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00228	                endif
	ICALL?L	L00001
	LABEL?L	L00070	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00229	                gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00230	            endif
	ICALL?L	L00001
	LABEL?L	L00067	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00231	            if (data_received[4] == "d") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 064h, L00071

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00232	                alstatus = 0
	ICALL?L	L00001
	MOVE?CB	000h, _ALSTATUS

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00233	                ALLeaveCounter = 0
	ICALL?L	L00001
	MOVE?CB	000h, _ALLeaveCounter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00234	                ALEnterCounter = 0
	ICALL?L	L00001
	MOVE?CB	000h, _ALEnterCounter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00235	                gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00236	            endif
	ICALL?L	L00001
	LABEL?L	L00071	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00237	            if (data_received[4] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 063h, L00073

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00238	                if (data_received[6] == "=") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00006h, 03Dh, L00075

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00239	                    i = 7
	ICALL?L	L00001
	MOVE?CB	007h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00240	                    gosub convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00241	                    if (conversionSuccess == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccess, 001h, L00077

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00242	                        if (data_received[5] == "e") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 065h, L00079

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00243	                            disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00244	                            write 14, temp_byte
	WRITE?CB	00Eh, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00245	                            enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00246	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00247	                        endif
	ICALL?L	L00001
	LABEL?L	L00079	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00248	                        if (data_received[5] == "l") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 06Ch, L00081

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00249	                            disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00250	                            write 15, temp_byte
	WRITE?CB	00Fh, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00251	                            enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00252	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00253	                        endif
	ICALL?L	L00001
	LABEL?L	L00081	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00259	    if (data_received[2] == "s") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 073h, L00083

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00260	        if (data_received[3] == "a") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 061h, L00085

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00261	            temp_data[0] = "1"
	ICALL?L	L00001
	MOVE?CB	031h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00262	            temp_data[1] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00263	            temp_data[2] = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00264	            temp_data[3] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00265	            temp_data[4] = ALSTATUS + $30
	ICALL?L	L00001
	ADD?BCB	_ALSTATUS, 030h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00266	            temp_data[5] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00267	            temp_data[6] = alarm + $30
	ICALL?L	L00001
	ADD?TCB	_alarm, 030h, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00268	            temp_data[7] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00007h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00269	            read 14, temp_byte 
	ICALL?L	L00001
	READ?CB	00Eh, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00270	            gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00271	            temp_data[8] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 00008h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00272	            temp_data[9] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 00009h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00273	            temp_data[10] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 0000Ah

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00274	            temp_data[11] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 0000Bh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00275	            read 15, temp_byte 
	ICALL?L	L00001
	READ?CB	00Fh, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00276	            gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00277	            temp_data[12] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 0000Ch

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00278	            temp_data[13] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 0000Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00279	            temp_data[14] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 0000Eh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00280	            temp_data[15] = 13            
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 0000Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00281	            temp_data[16] = 10            
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00010h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00282	        endif
	ICALL?L	L00001
	LABEL?L	L00085	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00283	        if (data_received[3] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 063h, L00087

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00284	            temp_data[0] = "1"
	ICALL?L	L00001
	MOVE?CB	031h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00285	            temp_data[1] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00286	            temp_data[2] = "c"
	ICALL?L	L00001
	MOVE?CB	063h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00287	            temp_data[3] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00288	            temp_data[4] = RELAY + $30
	ICALL?L	L00001
	ADD?TCB	_RELAY, 030h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00289	            temp_data[5] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00290	            read 11, temp_data[6]
	ICALL?L	L00001
	READ?CB	00Bh, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00291	            temp_data[6] = temp_data[6] + $30        
	ICALL?L	L00001
	ADD?BCB	_temp_data + 00006h, 030h, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00292	            temp_data[7] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00007h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00293	            read 13, temp_data[8]
	ICALL?L	L00001
	READ?CB	00Dh, _temp_data + 00008h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00294	            temp_data[8] = temp_data[8] + $30        
	ICALL?L	L00001
	ADD?BCB	_temp_data + 00008h, 030h, _temp_data + 00008h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00295	            temp_data[9] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00009h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00296	            read 12, temp_byte
	ICALL?L	L00001
	READ?CB	00Ch, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00297	            gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00298	            temp_data[10] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 0000Ah

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00299	            temp_data[11] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 0000Bh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00300	            temp_data[12] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 0000Ch

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00301	            temp_data[13] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 0000Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00302	            temp_byte = l1counter
	ICALL?L	L00001
	MOVE?BB	_l1counter, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00303	            gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00304	            temp_data[14] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 0000Eh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00305	            temp_data[15] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 0000Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00306	            temp_data[16] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 00010h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00307	            temp_data[17] = 13    
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00011h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00308	            temp_data[18] = 10    
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00012h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00309	        endif
	ICALL?L	L00001
	LABEL?L	L00087	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00311	    if (data_received[2] == "p") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 070h, L00089

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00312	            if (data_received[3] == "n") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 06Eh, L00091

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00313	                gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00316	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00093

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00317	        gosub sendDataError
	ICALL?L	L00001
	GOSUB?L	_sendDataError
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00320	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00321	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00322	end
	ICALL?L	L00001
	END?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00324	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00325	intManagement:

	LABEL?L	_intManagement	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00326	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON_2, 001h, L00095

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00327	           ticks = ticks + 1      ' Count pieces of seconds
	ADD?BCB	_ticks, 001h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00328	           if ticks = 5 then
	CMPNE?BCL	_ticks, 005h, L00097

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00329	                    for interi=0 to payloadLengthD - 1
	MOVE?CB	000h, _interi
	LABEL?L	L00099	
	CMPGT?BCL	_interi, 017h, L00100

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00330	                        data_received[interi] = 0
	AIN?CBB	000h, _data_received, _interi

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00331	                    next interi
	NEXT?BCL	_interi, 001h, L00099
	LABEL?L	L00100	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00332	           endif
	LABEL?L	L00097	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00333	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00334	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00335	           seconds = seconds + 1
	ADD?BCB	_seconds, 001h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00336	           if (ALEnterCounter > 0) then
	CMPLE?BCL	_ALEnterCounter, 000h, L00101

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00337	                ALEnterCounter = ALEnterCounter - 1
	SUB?BCB	_ALEnterCounter, 001h, _ALEnterCounter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00338	                if (ALEnterCounter == 0) && (alstatus == 4) then
	CMPEQ?BCB	_ALEnterCounter, 000h, T1
	CMPEQ?BCB	_ALSTATUS, 004h, T2
	LAND?BBW	T1, T2, T2
	CMPF?WL	T2, L00103

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00339	                      alstatus = 5                      
	MOVE?CB	005h, _ALSTATUS

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00340	                endif
	LABEL?L	L00103	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00341	           endif
	LABEL?L	L00101	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00342	           if (ALLeaveCounter > 0) then
	CMPLE?BCL	_ALLeaveCounter, 000h, L00105

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00343	               ALLeaveCounter = ALLeaveCounter - 1
	SUB?BCB	_ALLeaveCounter, 001h, _ALLeaveCounter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00344	               if (ALLeaveCounter == 0) && (alstatus == 3) then
	CMPEQ?BCB	_ALLeaveCounter, 000h, T1
	CMPEQ?BCB	_ALSTATUS, 003h, T2
	LAND?BBW	T1, T2, T2
	CMPF?WL	T2, L00107

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00345	                    alstatus = 1
	MOVE?CB	001h, _ALSTATUS

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00346	               endif 
	LABEL?L	L00107	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00347	           endif
	LABEL?L	L00105	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00348	           if (alarm == 1) THEN
	CMPNE?TCL	_alarm, 001h, L00109

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00349	               if (alarmCounter > 0) then
	CMPLE?BCL	_alarmCounter, 000h, L00111

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00350	                    if (ALSTATUS == 1) then
	CMPNE?BCL	_ALSTATUS, 001h, L00113

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00352	                        READ 14, ALEnterCounter
	READ?CB	00Eh, _ALEnterCounter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00353	                        if (ALEnterCounter == 0) then
	CMPNE?BCL	_ALEnterCounter, 000h, L00115

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00354	                            ALSTATUS = 5
	MOVE?CB	005h, _ALSTATUS

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00355	                        else
	GOTO?L	L00116
	LABEL?L	L00115	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00356	                            ALSTATUS = 4
	MOVE?CB	004h, _ALSTATUS

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00357	                        endif
	LABEL?L	L00116	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00358	                    endif
	LABEL?L	L00113	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00359	                    if (l1onAlarm = 1) then
	CMPNE?BCL	_l1onAlarm, 001h, L00117

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00360	                        seconds = 0
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00361	                        read 12, l1counter
	READ?CB	00Ch, _l1counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00362	                        gosub highRelay
	GOSUB?L	_highRelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00363	                    endif                    
	LABEL?L	L00117	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00364	                    alarmCounter = 0
	MOVE?CB	000h, _alarmCounter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00365	               else
	GOTO?L	L00112
	LABEL?L	L00111	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00366	                    alarmCounter = alarmCounter + 1
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00369	           if (relay_alarm_counter > 0) then
	CMPLE?BCL	_relay_alarm_counter, 000h, L00119

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00370	               relay_alarm_counter = relay_alarm_counter - 1
	SUB?BCB	_relay_alarm_counter, 001h, _relay_alarm_counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00371	               if (relay_alarm_counter == 0) then
	CMPNE?BCL	_relay_alarm_counter, 000h, L00121

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00372	                    input alarm
	INPUT?T	_alarm

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00373	               endif 
	LABEL?L	L00121	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00374	           endif
	LABEL?L	L00119	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00375	           if seconds < 59 then tiexit
	CMPLT?BCL	_seconds, 03Bh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00376	           seconds = 0
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00377	           if (l1counter > 0) then
	CMPLE?BCL	_l1counter, 000h, L00123

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00378	               l1counter = l1counter - 1
	SUB?BCB	_l1counter, 001h, _l1counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00379	               if (l1counter == 0) then
	CMPNE?BCL	_l1counter, 000h, L00125

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00380	                    gosub lowrelay
	GOSUB?L	_lowrelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00381	               endif
	LABEL?L	L00125	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00382	           endif           
	LABEL?L	L00123	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00383	           tiexit: 

	LABEL?L	_tiexit	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00384	           INTCON.2 = 0
	MOVE?CT	000h, _INTCON_2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00385	        endif
	LABEL?L	L00095	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00386	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON_7

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00387	resume
	RESUME?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00388	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00390	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00391	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00392	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00393	    temp_data[2] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00394	    temp_data[3] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00395	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00397	sendDataError:

	LABEL?L	_sendDataError	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00398	        temp_data[0] = "E"
	ICALL?L	L00001
	MOVE?CB	045h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00399	        temp_data[1] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00400	        temp_data[2] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00401	        temp_data[3] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00402	        temp_data[4] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00403	        temp_data[5] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00404	        temp_data[6] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00405	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00407	convertInputData:

	LABEL?L	_convertInputData	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00408	    conversionSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00409	    TEMP_BYTE="a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00410	    for k=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _k
	LABEL?L	L00127	
	CMPGT?BCL	_k, 002h, L00128

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00411	        TEMP1_BYTE = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00412	        TEMP2_BYTE = data_received[i]
	ICALL?L	L00001
	AOUT?BBB	_data_received, _i, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00413	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00129
	RETURN?	
	LABEL?L	L00129	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00414	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00415	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00131
	RETURN?	
	LABEL?L	L00131	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00416	        if (k==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_k, 000h, L00133

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00417	            TEMP_BYTE = TEMP1_BYTE 
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00418	            conversionSuccess = 1
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00419	        else 
	ICALL?L	L00001
	GOTO?L	L00134
	LABEL?L	L00133	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00420	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE 
	ICALL?L	L00001
	MUL?BCW	_temp_byte, 00Ah, T1
	ADD?WBB	T1, _temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00421	            conversionSuccess = 1
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00422	        endif
	ICALL?L	L00001
	LABEL?L	L00134	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00423	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00424	    next k
	ICALL?L	L00001
	NEXT?BCL	_k, 001h, L00127
	LABEL?L	L00128	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00425	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00427	lookupChar:

	LABEL?L	_lookupChar	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00428	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00429	RETURN
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00431	convertNoToStr:

	LABEL?L	_convertNoToStr	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00432	        temp3_byte = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCB	T1, 030h, _temp3_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00433	        temp2_byte = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 001h, T1
	ADD?WCB	T1, 030h, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00434	        temp1_byte = (temp_byte DIG 0) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 000h, T1
	ADD?WCB	T1, 030h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00435	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00437	highRelay:

	LABEL?L	_highRelay	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00438	if (relay == 0) then
	ICALL?L	L00001
	CMPNE?TCL	_RELAY, 000h, L00135

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00439	    relay_alarm_counter = 4
	ICALL?L	L00001
	MOVE?CB	004h, _relay_alarm_counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00440	    output alarm
	ICALL?L	L00001
	OUTPUT?T	_alarm

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00441	    low alarm
	ICALL?L	L00001
	LOW?T	_alarm

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00442	    high relay
	ICALL?L	L00001
	HIGH?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00443	endif
	ICALL?L	L00001
	LABEL?L	L00135	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00446	lowRelay:

	LABEL?L	_lowrelay	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00447	if (relay == 1) then
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00451	    low relay
	ICALL?L	L00001
	LOW?T	_RELAY
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00455	setRxAddressPipe:

	LABEL?L	_setRxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00456	READ 6, data_out[1]
	ICALL?L	L00001
	READ?CB	006h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00457	READ 7, data_out[2]
	ICALL?L	L00001
	READ?CB	007h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00458	READ 8, data_out[3]
	ICALL?L	L00001
	READ?CB	008h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00459	READ 9, data_out[4]
	ICALL?L	L00001
	READ?CB	009h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00460	data_out[5] = device_id
	ICALL?L	L00001
	MOVE?BB	_device_id, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00461	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00463	setTxAddressPipe:

	LABEL?L	_setTxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00464	READ 1, data_out[1]
	ICALL?L	L00001
	READ?CB	001h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00465	READ 2, data_out[2]
	ICALL?L	L00001
	READ?CB	002h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00466	READ 3, data_out[3]
	ICALL?L	L00001
	READ?CB	003h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00467	READ 4, data_out[4]
	ICALL?L	L00001
	READ?CB	004h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00468	READ 5, data_out[5]
	ICALL?L	L00001
	READ?CB	005h, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\LIGHTA~1.PBP	00469	return
	ICALL?L	L00001
	RETURN?	
