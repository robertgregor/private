...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00025	A000AB	device_id var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00019	A000AE	k VAR byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00012	A000B1	num_byte var byte 'temp value
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00021	A000B4	temp1_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00022	A000B6	temp2_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00023	A000B8	temp3_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00024	A000BA	temp4_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00020	A000BD	temp_byte_rfm var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00013	A000BF	val var byte 'temp value
_val             		EQU	RAM_START + 09Fh
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\RFM70.PBP	00018	A000C0	w var byte
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00124	        if (ALEnterCounter == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_ALEnterCounter, 000h, L00029
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00132	if (ALSTATUS == 5) then
	ICALL?L	L00001
	CMPNE?BCL	_ALSTATUS, 005h, L00031
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00154	if (data_in[1] == temp_byte) then
	ICALL?L	L00001
	CMPNE?BBL	_data_in + 00001h, _temp_byte, L00035
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00156	        if (data_in[3] == "=") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00003h, 03Dh, L00039
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00182	                if (data_in[5] == "d") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00005h, 064h, L00051
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00187	                if (data_in[5] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00005h, 063h, L00053
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00192	                if (data_in[5] == "t") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00005h, 074h, L00055

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00193	                    if (data_in[6] == "=") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00006h, 03Dh, L00057
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00196	                        if (conversionSuccess == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccess, 001h, L00059
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00216	            if (data_in[4] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00004h, 066h, L00065
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00227	                if (ALLeaveCounter == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_ALLeaveCounter, 000h, L00073
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00234	            if (data_in[4] == "d") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00004h, 064h, L00075
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00240	            if (data_in[4] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00004h, 063h, L00077

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00241	                if (data_in[6] == "=") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00006h, 03Dh, L00079
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00244	                    if (conversionSuccess == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccess, 001h, L00081

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00245	                        if (data_in[5] == "e") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00005h, 065h, L00083
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00249	                        if (data_in[5] == "l") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00005h, 06Ch, L00085
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00282	        if (data_in[3] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_in + 00003h, 063h, L00091
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00315	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00097
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00335	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON??2, 001h, L00099
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00354	           if (l1counter > 0) then
	CMPLE?BCL	_l1counter, 000h, L00109
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00356	               if (l1counter == 0) then
	CMPNE?BCL	_l1counter, 000h, L00111
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\REMOTE~1.PBP	00390	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00115
	RETURN?	
	LABEL?L	L00115	
