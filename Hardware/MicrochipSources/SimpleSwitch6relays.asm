...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00075	lcounter var byte[7]
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00078	startProgram:

	LABEL?L	_startProgram	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00079	clear
	ICALL?L	L00001
	CLEAR?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00080	input RES
	ICALL?L	L00001
	INPUT?T	_RES

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00081	output relay1
	ICALL?L	L00001
	OUTPUT?T	_RELAY1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00082	output relay2
	ICALL?L	L00001
	OUTPUT?T	_RELAY2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00083	output relay3
	ICALL?L	L00001
	OUTPUT?T	_RELAY3

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00084	output relay4
	ICALL?L	L00001
	OUTPUT?T	_RELAY4

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00085	output relay5
	ICALL?L	L00001
	OUTPUT?T	_RELAY5

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00086	output relay6
	ICALL?L	L00001
	OUTPUT?T	_RELAY6

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00088	READ 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00089	for i = 0 to 10 step 2
	ICALL?L	L00001
	MOVE?CB	000h, _i
	LABEL?L	L00019	
	CMPGT?BCL	_i, 00Ah, L00020

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00090	    READ (I+11), temp1_byte
	ICALL?L	L00001
	ADD?BCW	_i, 00Bh, T1
	READ?WB	T1, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00091	    temp_byte = (i / 2) + 1
	ICALL?L	L00001
	DIV?BCW	_i, 002h, T1
	ADD?WCB	T1, 001h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00092	    if (temp1_byte == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 000h, L00021

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00093	        gosub switchOnRelay
	ICALL?L	L00001
	GOSUB?L	_switchOnRelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00094	    else
	ICALL?L	L00001
	GOTO?L	L00022
	LABEL?L	L00021	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00095	        gosub switchOffRelay
	ICALL?L	L00001
	GOSUB?L	_switchOffRelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00096	    endif
	ICALL?L	L00001
	LABEL?L	L00022	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00097	next i
	ICALL?L	L00001
	NEXT?BCL	_i, 002h, L00019
	LABEL?L	L00020	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00098	gosub initModule
	ICALL?L	L00001
	GOSUB?L	_initModule

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00099	commonSettings:

	LABEL?L	_commonSettings	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00100	gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00101	gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00104	Main_rx:

	LABEL?L	_Main_rx	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00105	gosub setup_rx 'setup Rx
	ICALL?L	L00001
	GOSUB?L	_setup_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00106	pause 2 'delay for Rx starting
	ICALL?L	L00001
	PAUSE?C	002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00107	Ce=1 'set nRF24L01 in Rx mode
	ICALL?L	L00001
	MOVE?CT	001h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00108	irqLoop:

	LABEL?L	_irqLoop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00109	if RES == 0 then
	ICALL?L	L00001
	CMPNE?TCL	_RES, 000h, L00023

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00110	    DISABLE
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00111	    write 0, 40
	WRITE?CC	000h, 028h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00112	    write 1, "R"
	WRITE?CC	001h, 052h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00113	    write 2, "E"
	WRITE?CC	002h, 045h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00114	    write 3, "M"
	WRITE?CC	003h, 04Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00115	    write 4, "O"
	WRITE?CC	004h, 04Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00116	    write 5, "T"
	WRITE?CC	005h, 054h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00117	    write 6, "E"
	WRITE?CC	006h, 045h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00118	    write 7, "H"
	WRITE?CC	007h, 048h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00119	    write 8, "O"
	WRITE?CC	008h, 04Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00120	    write 9, "M"
	WRITE?CC	009h, 04Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00121	    write 10, 0    
	WRITE?CC	00Ah, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00122	    write 11, 1    
	WRITE?CC	00Bh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00123	    write 12, 0    
	WRITE?CC	00Ch, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00124	    write 13, 1    
	WRITE?CC	00Dh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00125	    write 14, 0    
	WRITE?CC	00Eh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00126	    write 15, 1    
	WRITE?CC	00Fh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00127	    write 16, 0    
	WRITE?CC	010h, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00128	    write 17, 1    
	WRITE?CC	011h, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00129	    write 18, 0    
	WRITE?CC	012h, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00130	    write 19, 1    
	WRITE?CC	013h, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00131	    write 20, 0    
	WRITE?CC	014h, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00132	    write 21, 1    
	WRITE?CC	015h, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00133	    write 22, 0    
	WRITE?CC	016h, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00134	    ENABLE
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00135	    pause 1000
	ICALL?L	L00001
	PAUSE?C	003E8h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00136	    goto startProgram
	ICALL?L	L00001
	GOTO?L	_startProgram

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00137	endif
	ICALL?L	L00001
	LABEL?L	L00023	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00139	if (temp_data[0] != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_temp_data, 000h, L00025

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00140	    if (configure == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_configure, 001h, L00027

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00141	        gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00142	        configure = 0
	ICALL?L	L00001
	MOVE?CB	000h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00143	    endif
	ICALL?L	L00001
	LABEL?L	L00027	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00144	    gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00145	    temp_data[0] = 0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00146	    GOTO main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00147	endif
	ICALL?L	L00001
	LABEL?L	L00025	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00148	If Irq !=0 then irqLoop 'wait until IRQ, active low
	ICALL?L	L00001
	CMPNE?TCL	_Irq, 000h, _irqLoop

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00149	Ce=0
	ICALL?L	L00001
	MOVE?CT	000h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00150	lop:

	LABEL?L	_lop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00151	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00152	gosub ackData
	GOSUB?L	_ackData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00153	temp_data[0] = 0
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00154	if (data_received[1] == device_id) then
	CMPNE?BBL	_data_received + 00001h, _device_id, L00029

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00155	    if (data_received[2] == "c") then    
	CMPNE?BCL	_data_received + 00002h, 063h, L00031

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00156	        if (data_received[3] == "=") then
	CMPNE?BCL	_data_received + 00003h, 03Dh, L00033

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00158	            for i = 0 to 10
	MOVE?CB	000h, _i
	LABEL?L	L00035	
	CMPGT?BCL	_i, 00Ah, L00036

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00159	                disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00160	                write i, data_received[i+4]
	ADD?BCW	_i, 004h, T1
	AOUT?BWB	_data_received, T1, T1
	WRITE?BB	_i, T1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00161	                enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00162	            next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00035
	LABEL?L	L00036	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00163	            read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00164	            pause 250
	ICALL?L	L00001
	PAUSE?C	0FAh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00165	            configure = 1
	ICALL?L	L00001
	MOVE?CB	001h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00166	            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00167	        endif
	ICALL?L	L00001
	LABEL?L	L00033	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00168	    else
	ICALL?L	L00001
	GOTO?L	L00032
	LABEL?L	L00031	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00169	     if (data_received[2] == "l") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 06Ch, L00037

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00170	        I = 3
	ICALL?L	L00001
	MOVE?CB	003h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00171	        gosub convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00172	        if (conversionSuccess == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccess, 001h, L00039

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00173	            temp4_byte = temp_byte 'this is relay number
	ICALL?L	L00001
	MOVE?BB	_temp_byte, _temp4_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00174	            if (TEMP_BYTE > 0) then
	ICALL?L	L00001
	CMPLE?BCL	_temp_byte, 000h, L00041

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00175	                if (TEMP_BYTE < 7) then
	ICALL?L	L00001
	CMPGE?BCL	_temp_byte, 007h, L00043

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00176	                    if (data_received[4] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 063h, L00045

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00177	                        if (data_received[5] == "o") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 06Fh, L00047

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00178	                            disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00179	                            write 9+(temp4_byte*2), 0
	MUL?BCW	_temp4_byte, 002h, T1
	ADD?CWW	009h, T1, T1
	WRITE?WC	T1, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00180	                            enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00181	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00182	                        endif
	ICALL?L	L00001
	LABEL?L	L00047	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00183	                        if (data_received[5] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 066h, L00049

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00184	                            disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00185	                            write 9+(temp4_byte*2), 1
	MUL?BCW	_temp4_byte, 002h, T1
	ADD?CWW	009h, T1, T1
	WRITE?WC	T1, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00186	                            enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00187	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00188	                        endif
	ICALL?L	L00001
	LABEL?L	L00049	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00189	                        if (data_received[5] == "t") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 074h, L00051

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00190	                            if (data_received[6] == "=") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00006h, 03Dh, L00053

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00191	                                i = 7
	ICALL?L	L00001
	MOVE?CB	007h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00192	                                gosub convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00193	                                if (conversionSuccess == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccess, 001h, L00055

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00194	                                    disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00195	                                    write 10+(temp4_byte*2), temp_byte
	MUL?BCW	_temp4_byte, 002h, T1
	ADD?CWW	00Ah, T1, T1
	WRITE?WB	T1, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00196	                                    enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00197	                                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00198	                                endif
	ICALL?L	L00001
	LABEL?L	L00055	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00199	                            endif
	ICALL?L	L00001
	LABEL?L	L00053	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00200	                        endif                
	ICALL?L	L00001
	LABEL?L	L00051	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00201	                    else
	ICALL?L	L00001
	GOTO?L	L00046
	LABEL?L	L00045	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00202	                     if (data_received[4] == "o") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 06Fh, L00057

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00203	                        if (data_received[5] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 066h, L00059

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00204	                            read 10+(temp4_byte*2), lcounter[temp4_byte]
	ICALL?L	L00001
	MUL?BCW	_temp4_byte, 002h, T1
	ADD?CWW	00Ah, T1, T1
	READ?WW	T1, T2
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00205	                            if (lcounter[temp4_byte] == 1) then
	ICALL?L	L00001
	AOUT?BBB	_lcounter, _temp4_byte, T1
	CMPNE?BCL	T1, 001h, L00061

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00206	                                if (seconds < 40) then lcounter[temp4_byte] = 2
	ICALL?L	L00001
	CMPGE?BCL	_seconds, 028h, L00063
	AIN?CBB	002h, _lcounter, _temp4_byte
	LABEL?L	L00063	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00207	                            endif
	ICALL?L	L00001
	LABEL?L	L00061	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00208	                            temp_byte = temp4_byte
	ICALL?L	L00001
	MOVE?BB	_temp4_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00209	                            gosub switchOnRelay
	ICALL?L	L00001
	GOSUB?L	_switchOnRelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00210	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00211	                        else
	ICALL?L	L00001
	GOTO?L	L00060
	LABEL?L	L00059	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00212	                            temp_byte = temp4_byte
	ICALL?L	L00001
	MOVE?BB	_temp4_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00213	                            gosub switchOnRelay
	ICALL?L	L00001
	GOSUB?L	_switchOnRelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00214	                            lcounter[temp4_byte] = 0
	ICALL?L	L00001
	AIN?CBB	000h, _lcounter, _temp4_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00215	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00216	                        endif
	ICALL?L	L00001
	LABEL?L	L00060	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00217	                     else
	ICALL?L	L00001
	GOTO?L	L00058
	LABEL?L	L00057	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00218	                      if (data_received[4] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 066h, L00065

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00219	                        temp_byte = temp4_byte
	ICALL?L	L00001
	MOVE?BB	_temp4_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00220	                        gosub switchOffRelay
	ICALL?L	L00001
	GOSUB?L	_switchOffRelay

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00221	                        gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00222	                      endif
	ICALL?L	L00001
	LABEL?L	L00065	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00223	                     endif
	ICALL?L	L00001
	LABEL?L	L00058	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00224	                    endif
	ICALL?L	L00001
	LABEL?L	L00046	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00228	     else
	ICALL?L	L00001
	GOTO?L	L00038
	LABEL?L	L00037	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00229	      if (data_received[2] == "s") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 073h, L00067

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00230	        I = 3
	ICALL?L	L00001
	MOVE?CB	003h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00231	        gosub convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00232	        if (conversionSuccess == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccess, 001h, L00069

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00233	            temp4_byte = temp_byte 'this is relay number
	ICALL?L	L00001
	MOVE?BB	_temp_byte, _temp4_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00234	            if (TEMP_BYTE > 0) then
	ICALL?L	L00001
	CMPLE?BCL	_temp_byte, 000h, L00071

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00235	                if (TEMP_BYTE < 7) then   
	ICALL?L	L00001
	CMPGE?BCL	_temp_byte, 007h, L00073

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00236	                    temp_data[0] = "3"
	ICALL?L	L00001
	MOVE?CB	033h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00237	                    temp_data[1] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00238	                    if (temp4_byte == 1) then temp_data[2] = RELAY1
	ICALL?L	L00001
	CMPNE?BCL	_temp4_byte, 001h, L00075
	MOVE?TB	_RELAY1, _temp_data + 00002h
	LABEL?L	L00075	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00239	                    if (temp4_byte == 2) then temp_data[2] = RELAY2
	ICALL?L	L00001
	CMPNE?BCL	_temp4_byte, 002h, L00077
	MOVE?TB	_RELAY2, _temp_data + 00002h
	LABEL?L	L00077	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00240	                    if (temp4_byte == 3) then temp_data[2] = RELAY3
	ICALL?L	L00001
	CMPNE?BCL	_temp4_byte, 003h, L00079
	MOVE?TB	_RELAY3, _temp_data + 00002h
	LABEL?L	L00079	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00241	                    if (temp4_byte == 4) then temp_data[2] = RELAY4
	ICALL?L	L00001
	CMPNE?BCL	_temp4_byte, 004h, L00081
	MOVE?TB	_RELAY4, _temp_data + 00002h
	LABEL?L	L00081	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00242	                    if (temp4_byte == 5) then temp_data[2] = RELAY5
	ICALL?L	L00001
	CMPNE?BCL	_temp4_byte, 005h, L00083
	MOVE?TB	_RELAY5, _temp_data + 00002h
	LABEL?L	L00083	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00243	                    if (temp4_byte == 6) then temp_data[2] = RELAY6                    
	ICALL?L	L00001
	CMPNE?BCL	_temp4_byte, 006h, L00085
	MOVE?TB	_RELAY6, _temp_data + 00002h
	LABEL?L	L00085	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00244	                    temp_data[2] = temp_data[2] + $30
	ICALL?L	L00001
	ADD?BCB	_temp_data + 00002h, 030h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00245	                    temp_data[3] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00246	                    read 9+(temp4_byte*2), temp_data[4]
	ICALL?L	L00001
	MUL?BCW	_temp4_byte, 002h, T1
	ADD?CWW	009h, T1, T1
	READ?WB	T1, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00247	                    temp_data[4] = temp_data[4] + $30        
	ICALL?L	L00001
	ADD?BCB	_temp_data + 00004h, 030h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00248	                    temp_data[5] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00249	                    read 10+(temp4_byte*2), temp_byte
	ICALL?L	L00001
	MUL?BCW	_temp4_byte, 002h, T1
	ADD?CWW	00Ah, T1, T1
	READ?WB	T1, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00250	                    gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00251	                    temp_data[6] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00252	                    temp_data[7] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 00007h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00253	                    temp_data[8] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 00008h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00254	                    temp_data[9] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00009h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00255	                    temp_byte = lcounter[temp4_byte]
	ICALL?L	L00001
	AOUT?BBB	_lcounter, _temp4_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00256	                    gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00257	                    temp_data[10] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 0000Ah

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00258	                    temp_data[11] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 0000Bh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00259	                    temp_data[12] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 0000Ch

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00260	                    temp_data[13] = 13    
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 0000Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00261	                    temp_data[14] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 0000Eh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00262	                endif
	ICALL?L	L00001
	LABEL?L	L00073	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00263	            endif
	ICALL?L	L00001
	LABEL?L	L00071	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00264	        endif
	ICALL?L	L00001
	LABEL?L	L00069	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00265	      else
	ICALL?L	L00001
	GOTO?L	L00068
	LABEL?L	L00067	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00266	       if (data_received[2] == "p") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 070h, L00087

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00267	        if (data_received[3] == "n") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 06Eh, L00089

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00268	            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00269	        endif
	ICALL?L	L00001
	LABEL?L	L00089	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00270	       endif
	ICALL?L	L00001
	LABEL?L	L00087	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00271	      endif
	ICALL?L	L00001
	LABEL?L	L00068	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00274	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00091

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00275	        temp_data[0] = "E"
	ICALL?L	L00001
	MOVE?CB	045h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00276	        temp_data[1] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00277	        temp_data[2] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00278	        temp_data[3] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00279	        temp_data[4] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00280	        temp_data[5] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00281	        temp_data[6] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00282	    endif
	ICALL?L	L00001
	LABEL?L	L00091	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00283	endif
	ICALL?L	L00001
	LABEL?L	L00029	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00284	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00285	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00286	end
	ICALL?L	L00001
	END?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00288	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00289	intManagement:

	LABEL?L	_intManagement	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00290	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON_2, 001h, L00093

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00291	           ticks = ticks + 1      ' Count pieces of seconds
	ADD?BCB	_ticks, 001h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00292	           if ticks = 5 then
	CMPNE?BCL	_ticks, 005h, L00095

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00293	                    for interi=0 to payloadLengthD - 1
	MOVE?CB	000h, _interi
	LABEL?L	L00097	
	CMPGT?BCL	_interi, 017h, L00098

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00294	                        data_received[interi] = 0
	AIN?CBB	000h, _data_received, _interi

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00295	                    next interi
	NEXT?BCL	_interi, 001h, L00097
	LABEL?L	L00098	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00296	           endif           
	LABEL?L	L00095	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00297	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00298	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00299	           seconds = seconds + 1
	ADD?BCB	_seconds, 001h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00300	           if seconds < 59 then tiexit
	CMPLT?BCL	_seconds, 03Bh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00301	           seconds = 0
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00302	           for iint = 1 to 6
	MOVE?CB	001h, _iint
	LABEL?L	L00099	
	CMPGT?BCL	_iint, 006h, L00100

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00303	               if (lcounter[iint] > 0) then
	AOUT?BBB	_lcounter, _iint, T1
	CMPLE?BCL	T1, 000h, L00101

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00304	                   lcounter[iint] = lcounter[iint] - 1
	AOUT?BBB	_lcounter, _iint, T1
	SUB?BCW	T1, 001h, T1
	AIN?WBB	T1, _lcounter, _iint

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00305	                   if (lcounter[iint] == 0) then
	AOUT?BBB	_lcounter, _iint, T1
	CMPNE?BCL	T1, 000h, L00103

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00306	                        if (iint = 1) then low relay1
	CMPNE?BCL	_iint, 001h, L00105
	LOW?T	_RELAY1
	LABEL?L	L00105	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00307	                        if (iint = 2) then low relay2
	CMPNE?BCL	_iint, 002h, L00107
	LOW?T	_RELAY2
	LABEL?L	L00107	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00308	                        if (iint = 3) then low relay3
	CMPNE?BCL	_iint, 003h, L00109
	LOW?T	_RELAY3
	LABEL?L	L00109	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00309	                        if (iint = 4) then low relay4
	CMPNE?BCL	_iint, 004h, L00111
	LOW?T	_RELAY4
	LABEL?L	L00111	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00310	                        if (iint = 5) then low relay5
	CMPNE?BCL	_iint, 005h, L00113
	LOW?T	_RELAY5
	LABEL?L	L00113	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00311	                        if (iint = 6) then low relay6
	CMPNE?BCL	_iint, 006h, L00115
	LOW?T	_RELAY6
	LABEL?L	L00115	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00312	                   endif
	LABEL?L	L00103	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00313	               endif           
	LABEL?L	L00101	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00314	           next iint
	NEXT?BCL	_iint, 001h, L00099
	LABEL?L	L00100	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00315	           tiexit:

	LABEL?L	_tiexit	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00316	           INTCON.2 = 0 
	MOVE?CT	000h, _INTCON_2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00317	        endif
	LABEL?L	L00093	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00318	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON_7

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00319	resume
	RESUME?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00320	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00322	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00323	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00324	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00325	    temp_data[2] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00326	    temp_data[3] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00327	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00329	convertInputData:

	LABEL?L	_convertInputData	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00330	    conversionSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00331	    TEMP_BYTE="a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00332	    for ci=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _ci
	LABEL?L	L00117	
	CMPGT?BCL	_ci, 002h, L00118

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00333	        TEMP1_BYTE = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00334	        TEMP2_BYTE = data_received[i]
	ICALL?L	L00001
	AOUT?BBB	_data_received, _i, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00335	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00119
	RETURN?	
	LABEL?L	L00119	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00336	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00337	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00121
	RETURN?	
	LABEL?L	L00121	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00338	        if (ci==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_ci, 000h, L00123

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00339	            TEMP_BYTE = TEMP1_BYTE
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00340	            conversionSuccess = 1 
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00341	        else 
	ICALL?L	L00001
	GOTO?L	L00124
	LABEL?L	L00123	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00342	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE
	ICALL?L	L00001
	MUL?BCW	_temp_byte, 00Ah, T1
	ADD?WBB	T1, _temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00343	            conversionSuccess = 1
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00344	        endif
	ICALL?L	L00001
	LABEL?L	L00124	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00345	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00346	    next ci
	ICALL?L	L00001
	NEXT?BCL	_ci, 001h, L00117
	LABEL?L	L00118	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00347	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00349	lookupChar:

	LABEL?L	_lookupChar	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00350	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00351	RETURN
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00353	convertNoToStr:

	LABEL?L	_convertNoToStr	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00354	        temp3_byte = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCB	T1, 030h, _temp3_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00355	        temp2_byte = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 001h, T1
	ADD?WCB	T1, 030h, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00356	        temp1_byte = (temp_byte DIG 0) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 000h, T1
	ADD?WCB	T1, 030h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00357	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00359	switchOnRelay:

	LABEL?L	_switchOnRelay	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00360	    if (temp_byte == 1) then HIGH RELAY1
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 001h, L00125
	HIGH?T	_RELAY1
	LABEL?L	L00125	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00361	    if (temp_byte == 2) then HIGH RELAY2
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 002h, L00127
	HIGH?T	_RELAY2
	LABEL?L	L00127	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00362	    if (temp_byte == 3) then HIGH RELAY3
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 003h, L00129
	HIGH?T	_RELAY3
	LABEL?L	L00129	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00363	    if (temp_byte == 4) then HIGH RELAY4
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 004h, L00131
	HIGH?T	_RELAY4
	LABEL?L	L00131	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00364	    if (temp_byte == 5) then HIGH RELAY5
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 005h, L00133
	HIGH?T	_RELAY5
	LABEL?L	L00133	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00365	    if (temp_byte == 6) then HIGH RELAY6    
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 006h, L00135
	HIGH?T	_RELAY6
	LABEL?L	L00135	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00366	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00368	switchOffRelay:

	LABEL?L	_switchOffRelay	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00369	    if (temp_byte == 1) then LOW RELAY1
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 001h, L00137
	LOW?T	_RELAY1
	LABEL?L	L00137	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00370	    if (temp_byte == 2) then LOW RELAY2
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 002h, L00139
	LOW?T	_RELAY2
	LABEL?L	L00139	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00371	    if (temp_byte == 3) then LOW RELAY3
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 003h, L00141
	LOW?T	_RELAY3
	LABEL?L	L00141	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00372	    if (temp_byte == 4) then LOW RELAY4
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 004h, L00143
	LOW?T	_RELAY4
	LABEL?L	L00143	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00373	    if (temp_byte == 5) then LOW RELAY5
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 005h, L00145
	LOW?T	_RELAY5
	LABEL?L	L00145	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00374	    if (temp_byte == 6) then LOW RELAY6    
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 006h, L00147
	LOW?T	_RELAY6
	LABEL?L	L00147	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00375	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00377	setRxAddressPipe:

	LABEL?L	_setRxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00378	READ 6, data_out[1]
	ICALL?L	L00001
	READ?CB	006h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00379	READ 7, data_out[2]
	ICALL?L	L00001
	READ?CB	007h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00380	READ 8, data_out[3]
	ICALL?L	L00001
	READ?CB	008h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00381	READ 9, data_out[4]
	ICALL?L	L00001
	READ?CB	009h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00382	data_out[5] = device_id
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00385	setTxAddressPipe:

	LABEL?L	_setTxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00386	READ 1, data_out[1]
	ICALL?L	L00001
	READ?CB	001h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00387	READ 2, data_out[2]
	ICALL?L	L00001
	READ?CB	002h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00388	READ 3, data_out[3]
	ICALL?L	L00001
	READ?CB	003h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00389	READ 4, data_out[4]
	ICALL?L	L00001
	READ?CB	004h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~3.PBP	00390	READ 5, data_out[5]
	ICALL?L	L00001
