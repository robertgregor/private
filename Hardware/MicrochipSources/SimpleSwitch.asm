...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00032	    OPTION_REG = %00000100
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00040	WPUA = %11111111
	ICALL?L	L00001
	MOVE?CB	0FFh, WPUA

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00041	WPUB = %11111111
	ICALL?L	L00001
	MOVE?CB	0FFh, WPUB
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00221	           If ticks < 241 Then tiexit
	CMPLT?WCL	_ticks, 0F1h, _tiexit
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00233	        endif
	LABEL?L	L00059	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00234	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON??7

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00235	resume
	RESUME?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00236	enable
	ENABLE?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00238	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00239	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00240	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00241	    temp_data[2] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00002h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00242	    temp_data[3] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00003h

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00243	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00245	convertInputData:

	LABEL?L	_convertInputData	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00246	    conversionSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccess

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00247	    TEMP_BYTE="a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00248	    for ci=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _ci
	LABEL?L	L00065	
	CMPGT?BCL	_ci, 002h, L00066

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00249	        TEMP1_BYTE = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp1_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00250	        TEMP2_BYTE = data_in[i]
	ICALL?L	L00001
	AOUT?BBB	_data_in, _i, _temp2_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00251	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00067
	RETURN?	
	LABEL?L	L00067	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00252	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00253	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00069
	RETURN?	
	LABEL?L	L00069	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00254	        if (ci==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_ci, 000h, L00071

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00255	            TEMP_BYTE = TEMP1_BYTE
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00256	            conversionSuccess = 1 
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00257	        else 
	ICALL?L	L00001
	GOTO?L	L00072
	LABEL?L	L00071	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00258	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE
	ICALL?L	L00001
	MUL?BCW	_temp_byte, 00Ah, T1
	ADD?WBB	T1, _temp1_byte, _temp_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00259	            conversionSuccess = 1
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00260	        endif
	ICALL?L	L00001
	LABEL?L	L00072	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00261	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00262	    next ci
	ICALL?L	L00001
	NEXT?BCL	_ci, 001h, L00065
	LABEL?L	L00066	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00263	return
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00265	lookupChar:

	LABEL?L	_lookupChar	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00266	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00267	RETURN
	ICALL?L	L00001
	RETURN?	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00269	convertNoToStr:

	LABEL?L	_convertNoToStr	

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00270	        temp3_byte = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCB	T1, 030h, _temp3_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00271	        temp2_byte = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 001h, T1
	ADD?WCB	T1, 030h, _temp2_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00272	        temp1_byte = (temp_byte DIG 0) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 000h, T1
	ADD?WCB	T1, 030h, _temp1_byte

; C:\REMOTE~1\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00273	return
	ICALL?L	L00001
	RETURN?	
