...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00060	conversionSuccess VAR BYTE
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00059	l1counter var byte
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00062	startProg:

	LABEL?L	_startProg	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00063	clear
	ICALL?L	L00001
	CLEAR?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00064	input RES
	ICALL?L	L00001
	INPUT?T	_RES

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00065	output relay
	ICALL?L	L00001
	OUTPUT?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00066	READ 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00067	read 11, temp_byte
	ICALL?L	L00001
	READ?CB	00Bh, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00068	if (temp_byte == 0) then 
	ICALL?L	L00001
	CMPNE?BCL	_temp_byte, 000h, L00019

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00069	    high relay
	ICALL?L	L00001
	HIGH?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00070	else
	ICALL?L	L00001
	GOTO?L	L00020
	LABEL?L	L00019	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00071	    low relay
	ICALL?L	L00001
	LOW?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00072	endif
	ICALL?L	L00001
	LABEL?L	L00020	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00073	gosub initModule
	ICALL?L	L00001
	GOSUB?L	_initModule

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00075	commonSettings:

	LABEL?L	_commonSettings	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00076	gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00077	gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00080	Main_rx:

	LABEL?L	_Main_rx	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00081	gosub setup_rx 'setup Rx
	ICALL?L	L00001
	GOSUB?L	_setup_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00082	pause 2 'delay for Rx starting
	ICALL?L	L00001
	PAUSE?C	002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00083	Ce=1 'set nRF24L01 in Rx mode
	ICALL?L	L00001
	MOVE?CT	001h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00084	irqLoop:

	LABEL?L	_irqLoop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00085	if RES == 0 then
	ICALL?L	L00001
	CMPNE?TCL	_RES, 000h, L00021

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00086	    write 0, 40
	ICALL?L	L00001
	WRITE?CC	000h, 028h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00087	    write 1, "R"
	ICALL?L	L00001
	WRITE?CC	001h, 052h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00088	    write 2, "E"
	ICALL?L	L00001
	WRITE?CC	002h, 045h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00089	    write 3, "M"
	ICALL?L	L00001
	WRITE?CC	003h, 04Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00090	    write 4, "O"
	ICALL?L	L00001
	WRITE?CC	004h, 04Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00091	    write 5, "T"
	ICALL?L	L00001
	WRITE?CC	005h, 054h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00092	    write 6, "E"
	ICALL?L	L00001
	WRITE?CC	006h, 045h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00093	    write 7, "H"
	ICALL?L	L00001
	WRITE?CC	007h, 048h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00094	    write 8, "O"
	ICALL?L	L00001
	WRITE?CC	008h, 04Fh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00095	    write 9, "M"
	ICALL?L	L00001
	WRITE?CC	009h, 04Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00096	    write 10, 0
	ICALL?L	L00001
	WRITE?CC	00Ah, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00097	    write 11, 1
	ICALL?L	L00001
	WRITE?CC	00Bh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00098	    write 12, 0
	ICALL?L	L00001
	WRITE?CC	00Ch, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00099	    pause 1000
	ICALL?L	L00001
	PAUSE?C	003E8h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00100	    goto startProg
	ICALL?L	L00001
	GOTO?L	_startProg

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00101	endif
	ICALL?L	L00001
	LABEL?L	L00021	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00103	if (temp_data[0] != 0) then
	ICALL?L	L00001
	CMPEQ?BCL	_temp_data, 000h, L00023

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00104	    if (configure == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_configure, 001h, L00025

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00105	        gosub commonRXTX
	ICALL?L	L00001
	GOSUB?L	_commonRXTX

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00106	        configure = 0
	ICALL?L	L00001
	MOVE?CB	000h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00107	    endif
	ICALL?L	L00001
	LABEL?L	L00025	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00108	    gosub sendData
	ICALL?L	L00001
	GOSUB?L	_sendData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00109	    temp_data[0] = 0
	ICALL?L	L00001
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00110	    GOTO main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00111	endif
	ICALL?L	L00001
	LABEL?L	L00023	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00112	If Irq !=0 then irqLoop 'wait until IRQ, active low
	ICALL?L	L00001
	CMPNE?TCL	_Irq, 000h, _irqLoop

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00113	Ce=0
	ICALL?L	L00001
	MOVE?CT	000h, _Ce

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00114	lop:

	LABEL?L	_lop	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00115	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00116	gosub ackData
	GOSUB?L	_ackData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00117	temp_data[0] = 0
	MOVE?CB	000h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00118	if (data_received[1] == device_id) then
	CMPNE?BBL	_data_received + 00001h, _device_id, L00027

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00119	    if (data_received[2] == "c") then    
	CMPNE?BCL	_data_received + 00002h, 063h, L00029

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00120	        if (data_received[3] == "=") then
	CMPNE?BCL	_data_received + 00003h, 03Dh, L00031

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00122	            for i = 0 to 10
	MOVE?CB	000h, _i
	LABEL?L	L00033	
	CMPGT?BCL	_i, 00Ah, L00034

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00123	                disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00124	                write i, data_received[i+4]
	ADD?BCW	_i, 004h, T1
	AOUT?BWB	_data_received, T1, T1
	WRITE?BB	_i, T1

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00125	                enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00126	            next i
	ICALL?L	L00001
	NEXT?BCL	_i, 001h, L00033
	LABEL?L	L00034	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00127	            read 10, device_id
	ICALL?L	L00001
	READ?CB	00Ah, _device_id

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00128	            pause 250
	ICALL?L	L00001
	PAUSE?C	0FAh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00129	            configure = 1
	ICALL?L	L00001
	MOVE?CB	001h, _configure

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00130	            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00131	        endif
	ICALL?L	L00001
	LABEL?L	L00031	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00132	    else
	ICALL?L	L00001
	GOTO?L	L00030
	LABEL?L	L00029	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00133	     if (data_received[2] == "l") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 06Ch, L00035

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00134	        if (data_received[3] == "1") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 031h, L00037

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00135	            if (data_received[4] == "c") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 063h, L00039

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00136	                if (data_received[5] == "o") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 06Fh, L00041

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00137	                    write 11, 0
	ICALL?L	L00001
	WRITE?CC	00Bh, 000h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00138	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00139	                endif
	ICALL?L	L00001
	LABEL?L	L00041	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00140	                if (data_received[5] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 066h, L00043

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00141	                    write 11, 1
	ICALL?L	L00001
	WRITE?CC	00Bh, 001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00142	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00143	                endif
	ICALL?L	L00001
	LABEL?L	L00043	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00144	                if (data_received[5] == "t") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 074h, L00045

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00145	                    if (data_received[6] == "=") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00006h, 03Dh, L00047

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00146	                        i = 7
	ICALL?L	L00001
	MOVE?CB	007h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00147	                        gosub convertInputData
	ICALL?L	L00001
	GOSUB?L	_convertInputData

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00148	                        if (conversionSuccess == 1) then
	ICALL?L	L00001
	CMPNE?BCL	_conversionSuccess, 001h, L00049

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00149	                            write 12, temp_byte
	ICALL?L	L00001
	WRITE?CB	00Ch, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00150	                            gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00151	                        endif
	ICALL?L	L00001
	LABEL?L	L00049	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00152	                    endif
	ICALL?L	L00001
	LABEL?L	L00047	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00154	            else
	ICALL?L	L00001
	GOTO?L	L00040
	LABEL?L	L00039	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00155	             if (data_received[4] == "o") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 06Fh, L00051

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00156	                if (data_received[5] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00005h, 066h, L00053

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00157	                    seconds = 0
	ICALL?L	L00001
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00158	                    ticks = 0
	ICALL?L	L00001
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00159	                    read 12, l1counter
	ICALL?L	L00001
	READ?CB	00Ch, _l1counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00160	                    high relay
	ICALL?L	L00001
	HIGH?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00161	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00162	                else
	ICALL?L	L00001
	GOTO?L	L00054
	LABEL?L	L00053	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00163	                    high relay
	ICALL?L	L00001
	HIGH?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00164	                    l1counter = 0
	ICALL?L	L00001
	MOVE?CB	000h, _l1counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00165	                    gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00166	                endif
	ICALL?L	L00001
	LABEL?L	L00054	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00167	             else
	ICALL?L	L00001
	GOTO?L	L00052
	LABEL?L	L00051	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00168	              if (data_received[4] == "f") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00004h, 066h, L00055

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00169	                LOW relay
	ICALL?L	L00001
	LOW?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00170	                gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00171	              endif
	ICALL?L	L00001
	LABEL?L	L00055	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00172	             endif
	ICALL?L	L00001
	LABEL?L	L00052	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00175	     else
	ICALL?L	L00001
	GOTO?L	L00036
	LABEL?L	L00035	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00176	      if (data_received[2] == "s") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 073h, L00057

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00177	            temp_data[0] = "3"
	ICALL?L	L00001
	MOVE?CB	033h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00178	            temp_data[1] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00179	            temp_data[2] = RELAY + $30
	ICALL?L	L00001
	ADD?TCB	_RELAY, 030h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00180	            temp_data[3] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00181	            read 11, temp_data[4]
	ICALL?L	L00001
	READ?CB	00Bh, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00182	            temp_data[4] = temp_data[4] + $30        
	ICALL?L	L00001
	ADD?BCB	_temp_data + 00004h, 030h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00183	            temp_data[5] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00184	            read 12, temp_byte
	ICALL?L	L00001
	READ?CB	00Ch, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00185	            gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00186	            temp_data[6] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00187	            temp_data[7] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 00007h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00188	            temp_data[8] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 00008h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00189	            temp_data[9] = "|"
	ICALL?L	L00001
	MOVE?CB	07Ch, _temp_data + 00009h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00190	            temp_byte = l1counter
	ICALL?L	L00001
	MOVE?BB	_l1counter, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00191	            gosub convertNoToStr
	ICALL?L	L00001
	GOSUB?L	_convertNoToStr

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00192	            temp_data[10] = temp3_byte
	ICALL?L	L00001
	MOVE?BB	_temp3_byte, _temp_data + 0000Ah

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00193	            temp_data[11] = temp2_byte
	ICALL?L	L00001
	MOVE?BB	_temp2_byte, _temp_data + 0000Bh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00194	            temp_data[12] = temp1_byte
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_data + 0000Ch

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00195	            temp_data[13] = 13    
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 0000Dh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00196	            temp_data[14] = 10    
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 0000Eh

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00197	      else
	ICALL?L	L00001
	GOTO?L	L00058
	LABEL?L	L00057	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00198	       if (data_received[2] == "p") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00002h, 070h, L00059

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00199	            if (data_received[3] == "n") then
	ICALL?L	L00001
	CMPNE?BCL	_data_received + 00003h, 06Eh, L00061

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00200	                gosub sendDataOK
	ICALL?L	L00001
	GOSUB?L	_sendDataOK

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00201	            endif
	ICALL?L	L00001
	LABEL?L	L00061	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00202	       endif
	ICALL?L	L00001
	LABEL?L	L00059	
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00206	    if (temp_data[0] == 0) then
	ICALL?L	L00001
	CMPNE?BCL	_temp_data, 000h, L00063

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00207	        temp_data[0] = "E"
	ICALL?L	L00001
	MOVE?CB	045h, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00208	        temp_data[1] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00209	        temp_data[2] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00210	        temp_data[3] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00211	        temp_data[4] = "R"
	ICALL?L	L00001
	MOVE?CB	052h, _temp_data + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00212	        temp_data[5] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00213	        temp_data[6] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00006h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00214	    endif
	ICALL?L	L00001
	LABEL?L	L00063	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00215	endif
	ICALL?L	L00001
	LABEL?L	L00027	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00216	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00217	GOTO Main_rx
	ICALL?L	L00001
	GOTO?L	_Main_rx

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00218	end
	ICALL?L	L00001
	END?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00220	disable
	DISABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00221	intManagement:

	LABEL?L	_intManagement	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00222	        if (INTCON.2 == 1) then
	CMPNE?TCL	_INTCON_2, 001h, L00065

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00223	           ticks = ticks + 1      ' Count pieces of seconds
	ADD?BCB	_ticks, 001h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00224	           if ticks = 10 then
	CMPNE?BCL	_ticks, 00Ah, L00067

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00225	                    for interi=0 to payloadLengthD - 1
	MOVE?CB	000h, _interi
	LABEL?L	L00069	
	CMPGT?BCL	_interi, 017h, L00070

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00226	                        data_received[interi] = 0
	AIN?CBB	000h, _data_received, _interi

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00227	                    next interi
	NEXT?BCL	_interi, 001h, L00069
	LABEL?L	L00070	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00228	           endif
	LABEL?L	L00067	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00229	           If ticks < 31 Then tiexit
	CMPLT?BCL	_ticks, 01Fh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00230	           ticks = 0
	MOVE?CB	000h, _ticks

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00231	           seconds = seconds + 1
	ADD?BCB	_seconds, 001h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00232	           if seconds < 59 then tiexit
	CMPLT?BCL	_seconds, 03Bh, _tiexit

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00233	           seconds = 0
	MOVE?CB	000h, _seconds

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00234	           if (l1counter > 0) then
	CMPLE?BCL	_l1counter, 000h, L00071

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00235	               l1counter = l1counter - 1
	SUB?BCB	_l1counter, 001h, _l1counter

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00236	               if (l1counter == 0) then
	CMPNE?BCL	_l1counter, 000h, L00073

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00237	                    low relay
	LOW?T	_RELAY

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00238	               endif
	LABEL?L	L00073	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00239	           endif           
	LABEL?L	L00071	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00240	           tiexit:

	LABEL?L	_tiexit	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00241	           INTCON.2 = 0 
	MOVE?CT	000h, _INTCON_2

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00242	        endif
	LABEL?L	L00065	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00243	        INTCON.7 = 1
	MOVE?CT	001h, _INTCON_7

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00244	resume
	RESUME?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00245	enable
	ENABLE?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00247	sendDataOK:

	LABEL?L	_sendDataOK	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00248	    temp_data[0] = "O"
	ICALL?L	L00001
	MOVE?CB	04Fh, _temp_data

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00249	    temp_data[1] = "K"
	ICALL?L	L00001
	MOVE?CB	04Bh, _temp_data + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00250	    temp_data[2] = 13
	ICALL?L	L00001
	MOVE?CB	00Dh, _temp_data + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00251	    temp_data[3] = 10
	ICALL?L	L00001
	MOVE?CB	00Ah, _temp_data + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00252	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00254	convertInputData:

	LABEL?L	_convertInputData	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00255	    conversionSuccess = 0
	ICALL?L	L00001
	MOVE?CB	000h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00256	    TEMP_BYTE="a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00257	    for ci=0 to 2    
	ICALL?L	L00001
	MOVE?CB	000h, _ci
	LABEL?L	L00075	
	CMPGT?BCL	_ci, 002h, L00076

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00258	        TEMP1_BYTE = "a"
	ICALL?L	L00001
	MOVE?CB	061h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00259	        TEMP2_BYTE = data_received[i]
	ICALL?L	L00001
	AOUT?BBB	_data_received, _i, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00260	        if (TEMP2_BYTE == "|") then return
	ICALL?L	L00001
	CMPNE?BCL	_temp2_byte, 07Ch, L00077
	RETURN?	
	LABEL?L	L00077	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00261	        GOSUB lookupChar
	ICALL?L	L00001
	GOSUB?L	_lookupChar

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00262	        if (TEMP1_BYTE == "a") then return 
	ICALL?L	L00001
	CMPNE?BCL	_temp1_byte, 061h, L00079
	RETURN?	
	LABEL?L	L00079	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00263	        if (ci==0) then 
	ICALL?L	L00001
	CMPNE?BCL	_ci, 000h, L00081

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00264	            TEMP_BYTE = TEMP1_BYTE
	ICALL?L	L00001
	MOVE?BB	_temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00265	            conversionSuccess = 1 
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00266	        else 
	ICALL?L	L00001
	GOTO?L	L00082
	LABEL?L	L00081	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00267	            TEMP_BYTE = TEMP_BYTE*10 + TEMP1_BYTE
	ICALL?L	L00001
	MUL?BCW	_temp_byte, 00Ah, T1
	ADD?WBB	T1, _temp1_byte, _temp_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00268	            conversionSuccess = 1
	ICALL?L	L00001
	MOVE?CB	001h, _conversionSuccess

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00269	        endif
	ICALL?L	L00001
	LABEL?L	L00082	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00270	        i = i + 1
	ICALL?L	L00001
	ADD?BCB	_i, 001h, _i

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00271	    next ci
	ICALL?L	L00001
	NEXT?BCL	_ci, 001h, L00075
	LABEL?L	L00076	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00272	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00274	lookupChar:

	LABEL?L	_lookupChar	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00275	    LOOKDOWN temp2_byte,["0123456789"], temp1_byte
	ICALL?L	L00001
...
; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00276	RETURN
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00278	convertNoToStr:

	LABEL?L	_convertNoToStr	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00279	        temp3_byte = (temp_byte DIG 2) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 002h, T1
	ADD?WCB	T1, 030h, _temp3_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00280	        temp2_byte = (temp_byte DIG 1) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 001h, T1
	ADD?WCB	T1, 030h, _temp2_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00281	        temp1_byte = (temp_byte DIG 0) + $30
	ICALL?L	L00001
	DIG?BCW	_temp_byte, 000h, T1
	ADD?WCB	T1, 030h, _temp1_byte

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00282	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00284	setRxAddressPipe:

	LABEL?L	_setRxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00285	READ 6, data_out[1]
	ICALL?L	L00001
	READ?CB	006h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00286	READ 7, data_out[2]
	ICALL?L	L00001
	READ?CB	007h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00287	READ 8, data_out[3]
	ICALL?L	L00001
	READ?CB	008h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00288	READ 9, data_out[4]
	ICALL?L	L00001
	READ?CB	009h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00289	data_out[5] = device_id
	ICALL?L	L00001
	MOVE?BB	_device_id, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00290	return
	ICALL?L	L00001
	RETURN?	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00292	setTxAddressPipe:

	LABEL?L	_setTxAddressPipe	

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00293	READ 1, data_out[1]
	ICALL?L	L00001
	READ?CB	001h, _data_out + 00001h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00294	READ 2, data_out[2]
	ICALL?L	L00001
	READ?CB	002h, _data_out + 00002h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00295	READ 3, data_out[3]
	ICALL?L	L00001
	READ?CB	003h, _data_out + 00003h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00296	READ 4, data_out[4]
	ICALL?L	L00001
	READ?CB	004h, _data_out + 00004h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00297	READ 5, data_out[5]
	ICALL?L	L00001
	READ?CB	005h, _data_out + 00005h

; C:\RH\PRIVATE\HARDWARE\MICROC~1\SIMPLE~1.PBP	00298	return
	ICALL?L	L00001
	RETURN?	
